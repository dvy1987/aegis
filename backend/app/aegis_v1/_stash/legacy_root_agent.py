"""CLEANUP: delete after ADK student workflow is live-verified (Phase 1+)."""
...
legacy_root_agent = Agent(
    ...
    instruction=LEGACY_AEGIS_V1_INSTRUCTION,
    tools=[
        case_parser,
        corpus_retrieval,
        phoenix_mcp_lookup,
...
legacy_app = App(root_agent=legacy_root_agent, name="aegis_v1")
