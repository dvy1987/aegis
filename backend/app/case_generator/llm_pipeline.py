"""Heuristics LLM case generator — Vertex/Gemini producer→critic swarm (canonical pipeline).
    ...
    for retry in range(MAX_SCENARIO_RETRIES):
        ...
        provenance = {
            ...
            "human_summary": (
                ...
                "Generated by Heuristics case_generator swarm with per-stage AlphaEval critics."
            ),
            "appeal_difficulty": {
