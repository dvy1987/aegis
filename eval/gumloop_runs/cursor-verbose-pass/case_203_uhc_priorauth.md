# Gumloop verbose pass — case_203_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** algo_boilerplate_fingerprint, incorrect_demographic_guideline  
**Profile:** 61F, Chronic migraine without aura (G43.709), Erenumab (Aimovig) preventive therapy
...
```json
{
  "case_id": "case_203_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
