# Gumloop verbose pass — case_395_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** wrong_appeals_contact, plan_exclusion_overrides_state_mandate  
**Profile:** 34F, Stage IV endometriosis (N80.4), Laparoscopic excision of endometriosis
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/27/2026",
    "Date of Service (requested): 02/07/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0135 under Aetna Clinical Policy Bullet",
...
```json
{
  "case_id": "case_395_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
