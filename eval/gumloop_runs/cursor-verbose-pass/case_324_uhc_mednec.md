# Gumloop verbose pass — case_324_uhc_mednec
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=M",
    "diagnosis=Lumbar disc herniation, suspected (M51.26)",
    "treatment_requested=MRI lumbar spine without contrast"
  ]
}
```
