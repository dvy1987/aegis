# Gumloop verbose pass — case_312_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** contraindication_to_step_therapy, experimental_despite_fda_approval  
**Profile:** 19M, Polycystic ovary syndrome with infertility (E28.2), Letrozole ovulation induction
...
```json
{
  "case_id": "case_312_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
