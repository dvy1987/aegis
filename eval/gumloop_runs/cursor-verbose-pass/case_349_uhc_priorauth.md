# Gumloop verbose pass — case_349_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** circular_medical_necessity, algo_time_delta  
**Profile:** 49F, Pelvic floor dysfunction postpartum (N81.9), Pelvic floor physical therapy (12 visits)
...
```json
{
  "case_id": "case_349_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
