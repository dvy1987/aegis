# Gumloop verbose pass — case_189_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** ignored_physician_letter, unreasonable_documentation_deadline  
...
```json
{
  "case_id": "case_189_uhc_mednec",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
  "reason": "Flaw Injection Verifier score 1 — missing: ignored_physician_letter, unreasonable_documentation_deadline.",
  "tier_1_failures": [],
  "tier_2_failures": [
