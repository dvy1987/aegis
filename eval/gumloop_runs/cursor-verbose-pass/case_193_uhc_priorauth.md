# Gumloop verbose pass — case_193_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** ignored_physician_letter, peer_to_peer_window_verbal_only  
**Profile:** 69F, Pulmonary embolism, suspected low-intermediate risk (I26.99), CT pulmonary angiography
...
```json
{
  "case_id": "case_193_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
  "reason": "Flaw Injection Verifier score 1 — missing: ignored_physician_letter, peer_to_peer_window_verbal_only.",
  "tier_1_failures": [],
  "tier_2_failures": [
