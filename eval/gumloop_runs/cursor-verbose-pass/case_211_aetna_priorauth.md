# Gumloop verbose pass — case_211_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** wrong_appeals_contact, ignored_physician_letter  
**Profile:** 34M, Major depressive disorder, recurrent, moderate (F33.1), Intensive outpatient program (IOP) for depression
...
```json
{
  "case_id": "case_211_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
