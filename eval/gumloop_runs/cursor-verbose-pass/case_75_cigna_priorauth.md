# Gumloop verbose pass — case_75_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** plan_exclusion_overrides_state_mandate, incorrect_demographic_guideline  
**Profile:** 19M, Plantar fasciitis, chronic (M72.2), Extracorporeal shock wave therapy
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "19M with Plantar fasciitis, chronic is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 19, \"gender\": \"M\""
  ],
...
```json
{
  "case_id": "case_75_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
