# Gumloop verbose pass — case_268_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** contraindication_to_step_therapy, wrong_appeals_contact  
**Profile:** 42F, Non-small cell lung cancer, stage IV EGFR+ (C34.90), Osimertinib third-line after T790M-negative progression
...
```json
{
  ...
  "analysis": "Non-small cell lung cancer, stage IV EGFR+ (C34.90) with Osimertinib third-line after T790M-negative progression is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=F",
    "diagnosis=Non-small cell lung cancer, stage IV EGFR+ (C34.90)",
    "treatment_requested=Osimertinib third-line after T790M-negative progression"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Osimertinib third-line after T790M-negative progression is a plausible intervention for Non-small cell lung cancer, stage IV EGFR+ (C34.90).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Non-small cell lung cancer, stage IV EGFR+ (C34.90)",
    "Osimertinib third-line after T790M-negative progression"
