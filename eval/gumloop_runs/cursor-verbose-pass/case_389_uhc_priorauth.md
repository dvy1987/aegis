# Gumloop verbose pass — case_389_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** appeal_closed_as_withdrawn, algo_time_delta  
**Profile:** 49F, Renal colic, recurrent (N23), Non-contrast CT abdomen/pelvis (CT KUB)
...
```json
{
  "case_id": "case_389_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
