# Gumloop verbose pass — case_183_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** superseded_guideline, plan_exclusion_overrides_state_mandate  
**Profile:** 64F, Cushing disease, suspected (E24.0), Pituitary MRI with endocrinology referral
...
```json
{
  "case_id": "case_183_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
