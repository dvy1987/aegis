# Gumloop verbose pass — case_379_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** plan_exclusion_overrides_state_mandate, incorrect_demographic_guideline  
**Profile:** 34M, Vulvodynia, generalized (N94.818), Vulvar vestibulitis physical therapy protocol
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/11/2026",
    "Date of Service (requested): 01/22/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "rrect demographic guideline). CPB 0119 under Aetna Clinical Policy Bul",
