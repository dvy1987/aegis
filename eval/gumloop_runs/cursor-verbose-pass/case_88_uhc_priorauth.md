# Gumloop verbose pass — case_88_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** contraindication_to_step_therapy, wrong_benefit_category  
**Profile:** 72M, Post-traumatic stress disorder, chronic (F43.12), Prolonged exposure therapy beyond visit cap
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "72M with Post-traumatic stress disorder, chronic is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 72, \"gender\": \"M\""
  ],
