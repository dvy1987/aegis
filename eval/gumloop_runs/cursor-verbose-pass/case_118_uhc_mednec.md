# Gumloop verbose pass — case_118_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** algo_boilerplate_fingerprint, step_therapy_vague_mcg  
**Profile:** 19F, Pilonidal disease, recurrent (L05.01), Excision with flap closure
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "19F with Pilonidal disease, recurrent is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 19, \"gender\": \"F\""
  ],
