# Gumloop verbose pass — case_298_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** unreasonable_documentation_deadline, algo_time_delta  
**Profile:** 19F, Insomnia disorder, chronic (G47.00), Cognitive behavioral therapy for insomnia (CBT-I), 8 sessions
...
```json
{
  ...
  "analysis": "Insomnia disorder, chronic (G47.00) with Cognitive behavioral therapy for insomnia (CBT-I), 8 sessions is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=19",
    "gender=F",
    "diagnosis=Insomnia disorder, chronic (G47.00)",
    "treatment_requested=Cognitive behavioral therapy for insomnia (CBT-I), 8 sessions"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Cognitive behavioral therapy for insomnia (CBT-I), 8 sessions is a plausible intervention for Insomnia disorder, chronic (G47.00).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Insomnia disorder, chronic (G47.00)",
    "Cognitive behavioral therapy for insomnia (CBT-I), 8 sessions"
