# Gumloop verbose pass — case_358_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** step_therapy_vague_mcg, circular_medical_necessity  
**Profile:** 19F, Obesity with BMI 42 and prediabetes (E66.01), GLP-1 receptor agonist (semaglutide 2.4 mg)
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Obesity with BMI 42 and prediabetes",
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Date of Service (requested): 05/01/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM138 under UnitedHealthcare Coverage D",
    "MCG Care Guidelines (edition not specified)"
  ],
  "improvement": null
}
```
