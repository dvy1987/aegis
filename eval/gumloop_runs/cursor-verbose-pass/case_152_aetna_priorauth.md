# Gumloop verbose pass — case_152_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** plan_exclusion_overrides_state_mandate, non_specialist_reviewer  
**Profile:** 68M, Immune thrombocytopenia, chronic (D69.3), Romiplostim (Nplate)
...
```json
{
  "case_id": "case_152_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
