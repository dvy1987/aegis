# Gumloop verbose pass — case_464_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** superseded_guideline, wrong_benefit_category  
**Profile:** 68F, Post-MI ventricular tachycardia (I25.2), Subcutaneous ICD
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 05/07/2026",
    "Date of Service (requested): 04/17/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "erseded guideline reference). CPB 0124 under Aetna Clinical Policy Bul",
