# Gumloop verbose pass — case_54_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** non_specialist_reviewer, algo_reviewer_no_credentials  
**Profile:** 58F, Binge-eating disorder (F50.81), Adjunct lisdexamfetamine for BED
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "58F with Binge-eating disorder is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 58, \"gender\": \"F\""
  ],
...
```json
{
  ...
  "verification_results": [
    ...
    },
    {
      ...
      "status": "PRESENT",
      "evidence": "Named Medical Director without specialty/credentials."
    }
  ],
  "score": 5,
  "confidence": 0.93,
