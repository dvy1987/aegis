# Gumloop verbose pass — case_305_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** mhpaea_visit_limit_asymmetry, appeal_closed_as_withdrawn  
**Profile:** 19F, Alcohol use disorder, severe (F10.20), Inpatient medical detoxification (3–5 days)
...
```json
{
  ...
  "evidence_quotes": [
    "age=19",
    "gender=F",
    "diagnosis=Alcohol use disorder, severe (F10.20)",
    "treatment_requested=Inpatient medical detoxification (3\u20135 days)"
  ]
}
```
...
```json
{
  "case_id": "case_305_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
