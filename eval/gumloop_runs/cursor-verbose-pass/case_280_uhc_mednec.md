# Gumloop verbose pass — case_280_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** contraindication_to_step_therapy, missing_iro_notice  
**Profile:** 72F, Amyotrophic lateral sclerosis (G12.21), Riluzole and multidisciplinary ALS clinic
...
```json
{
  ...
  "analysis": "Amyotrophic lateral sclerosis (G12.21) with Riluzole and multidisciplinary ALS clinic is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=72",
    "gender=F",
    "diagnosis=Amyotrophic lateral sclerosis (G12.21)",
    "treatment_requested=Riluzole and multidisciplinary ALS clinic"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Riluzole and multidisciplinary ALS clinic is a plausible intervention for Amyotrophic lateral sclerosis (G12.21).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Amyotrophic lateral sclerosis (G12.21)",
    "Riluzole and multidisciplinary ALS clinic"
