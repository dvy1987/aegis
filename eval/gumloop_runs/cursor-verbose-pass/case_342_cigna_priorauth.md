# Gumloop verbose pass — case_342_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, algo_time_delta  
**Profile:** 42F, Hereditary angioedema (D84.1), Lanadelumab prophylaxis
...
```json
{
  ...
  "analysis": "Hereditary angioedema (D84.1) with Lanadelumab prophylaxis is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=F",
    "diagnosis=Hereditary angioedema (D84.1)",
    "treatment_requested=Lanadelumab prophylaxis"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Lanadelumab prophylaxis is a plausible intervention for Hereditary angioedema (D84.1).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Hereditary angioedema (D84.1)",
    "Lanadelumab prophylaxis"
...
```json
{
  "case_id": "case_342_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
