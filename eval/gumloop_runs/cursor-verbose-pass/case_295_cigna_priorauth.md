# Gumloop verbose pass — case_295_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** missing_erisa_disclosures, unreasonable_documentation_deadline  
**Profile:** 68M, Chronic lymphocytic leukemia, symptomatic (C91.10), Venetoclax plus obinutuzumab
...
```json
{
  ...
  "evidence_quotes": [
    "age=68",
    "gender=M",
    "diagnosis=Chronic lymphocytic leukemia, symptomatic (C91.10)",
    "treatment_requested=Venetoclax plus obinutuzumab"
  ]
}
```
...
```json
{
  "case_id": "case_295_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
