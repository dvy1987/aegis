# Gumloop verbose pass — case_403_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** ignored_physician_letter, timeline_violation  
**Profile:** 19F, Pulmonary arterial hypertension, suspected (I27.0), Right heart catheterization
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Pulmonary arterial hypertension, suspected",
