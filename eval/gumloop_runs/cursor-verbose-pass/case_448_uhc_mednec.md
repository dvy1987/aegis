# Gumloop verbose pass — case_448_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** non_specialist_reviewer, timeline_violation  
**Profile:** 19M, Gynecomastia, persistent adolescent (N62), Subcutaneous mastectomy
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Gynecomastia, persistent adolescent",
