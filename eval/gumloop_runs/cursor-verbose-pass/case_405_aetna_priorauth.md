# Gumloop verbose pass — case_405_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** experimental_despite_fda_approval, algo_boilerplate_fingerprint  
**Profile:** 34F, Panic disorder with agoraphobia (F40.01), Psychiatric partial hospitalization
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/09/2026",
    "Date of Service (requested): 02/17/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0105 under Aetna Clinical Policy Bullet",
...
```json
{
  "case_id": "case_405_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
