# Gumloop verbose pass — case_297_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** wrong_appeals_contact, experimental_despite_fda_approval  
**Profile:** 72F, Post-concussion syndrome (G44.309), Multidisciplinary concussion clinic program
...
```json
{
  "case_id": "case_297_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
