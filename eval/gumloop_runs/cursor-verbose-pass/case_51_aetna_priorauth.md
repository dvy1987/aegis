# Gumloop verbose pass — case_51_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** wrong_appeals_contact, superseded_guideline  
**Profile:** 63M, Plantar fasciitis, chronic (M72.2), Extracorporeal shock wave therapy
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "63M with Plantar fasciitis, chronic is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 63, \"gender\": \"M\""
  ],
...
```json
{
  "case_id": "case_51_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
