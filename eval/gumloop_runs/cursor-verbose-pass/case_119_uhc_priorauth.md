# Gumloop verbose pass — case_119_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** unreasonable_documentation_deadline, algo_boilerplate_fingerprint  
**Profile:** 49M, Paroxysmal atrial fibrillation (I48.0), Catheter ablation for symptomatic AFib
...
```json
{
  ...
  "analysis": "Paroxysmal atrial fibrillation (I48.0) with Catheter ablation for symptomatic AFib is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "49M with Paroxysmal atrial fibrillation is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 49, \"gender\": \"M\""
  ],
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Catheter ablation for symptomatic AFib is a plausible intervention for Paroxysmal atrial fibrillation (I48.0).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Paroxysmal atrial fibrillation (I48.0)",
    "Catheter ablation for symptomatic AFib"
...
```json
{
  "case_id": "case_119_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
