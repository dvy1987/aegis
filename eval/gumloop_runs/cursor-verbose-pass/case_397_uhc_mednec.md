# Gumloop verbose pass — case_397_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** missing_iro_notice, unreasonable_documentation_deadline  
**Profile:** 67M, Plaque psoriasis, moderate (L40.0), Adalimumab (Humira)
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/01/2026",
    "Date of Service (requested): 02/09/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "ria. Clinical policy applied: CDG-UM137 under UnitedHealthcare Coverag",
    "ecessary under plan criteria. Clinical policy applied: CDG-UM137 under"
  ],
  "improvement": null
}
```
