# Gumloop verbose pass — case_271_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** timeline_violation, ignored_physician_letter  
**Profile:** 34F, Pemphigus vulgaris (L10.0), Rituximab infusion
...
```json
{
  ...
  "evidence_quotes": [
    "age=34",
    "gender=F",
    "diagnosis=Pemphigus vulgaris (L10.0)",
    "treatment_requested=Rituximab infusion"
  ]
}
```
...
```json
{
  "case_id": "case_271_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
