# Gumloop verbose pass — case_483_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** unreasonable_documentation_deadline, algo_time_delta  
**Profile:** 58F, Ovarian cancer, platinum-sensitive recurrence (C56.9), Secondary cytoreductive surgery evaluation
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM103 under UnitedHealthcare Coverage D",
    "Clinical policy applied: CDG-UM103 under UnitedHealthca"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_483_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
