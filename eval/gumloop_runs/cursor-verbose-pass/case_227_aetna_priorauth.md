# Gumloop verbose pass — case_227_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** non_specialist_reviewer, algo_boilerplate_fingerprint  
**Profile:** 19F, HR-positive, HER2-negative early breast cancer (C50.911), Adjuvant abemaciclib with endocrine therapy
...
```json
{
  "case_id": "case_227_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
