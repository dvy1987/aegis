# Gumloop verbose pass — case_487_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** wrong_benefit_category, missing_iro_notice  
**Profile:** 19M, Vulvodynia, generalized (N94.818), Vulvar vestibulitis physical therapy protocol
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 01/30/2026",
    "Date of Service (requested): 01/10/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "ice. Clinical policy applied: CDG-UM107 under UnitedHealthcare Coverag",
    "l before the date of service. Clinical policy applied: CDG-UM107 under"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_487_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
