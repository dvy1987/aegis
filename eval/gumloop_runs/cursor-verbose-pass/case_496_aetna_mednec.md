# Gumloop verbose pass — case_496_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** wrong_appeals_contact, experimental_despite_fda_approval  
**Profile:** 27F, Non-small cell lung cancer, stage IV EGFR+ (C34.90), Osimertinib third-line after T790M-negative progression
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Non-small cell lung cancer, stage IV EGFR+",
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/08/2026",
    "Date of Service (requested): 01/19/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0116 under Aetna Clinical Policy Bullet",
