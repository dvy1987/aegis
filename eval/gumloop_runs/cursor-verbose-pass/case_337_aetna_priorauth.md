# Gumloop verbose pass — case_337_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, incorrect_demographic_guideline  
**Profile:** 49M, Severe obsessive-compulsive disorder (F42.2), Transcranial magnetic stimulation (TMS)
...
```json
{
  ...
  "evidence_quotes": [
    "age=49",
    "gender=M",
    "diagnosis=Severe obsessive-compulsive disorder (F42.2)",
    "treatment_requested=Transcranial magnetic stimulation (TMS)"
  ]
}
```
...
```json
{
  "case_id": "case_337_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
