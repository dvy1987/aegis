# Gumloop verbose pass — case_293_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** wrong_benefit_category, appeal_closed_as_withdrawn  
**Profile:** 49M, Primary osteoporosis (M81.0), Teriparatide anabolic therapy
...
```json
{
  ...
  "evidence_quotes": [
    "age=49",
    "gender=M",
    "diagnosis=Primary osteoporosis (M81.0)",
    "treatment_requested=Teriparatide anabolic therapy"
  ]
}
```
