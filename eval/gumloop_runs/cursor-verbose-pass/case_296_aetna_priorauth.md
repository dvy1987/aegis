# Gumloop verbose pass — case_296_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** ignored_physician_letter, appeal_closed_as_withdrawn  
**Profile:** 62F, Carpal tunnel with neurology referral (G56.00), Nerve conduction study and splinting
...
```json
{
  ...
  "evidence_quotes": [
    "age=62",
    "gender=F",
    "diagnosis=Carpal tunnel with neurology referral (G56.00)",
    "treatment_requested=Nerve conduction study and splinting"
  ]
}
```
...
```json
{
  "case_id": "case_296_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
