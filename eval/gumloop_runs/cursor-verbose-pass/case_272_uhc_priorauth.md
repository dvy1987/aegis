# Gumloop verbose pass — case_272_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** peer_to_peer_window_verbal_only, non_specialist_reviewer  
**Profile:** 42M, Frozen shoulder (M75.00), Manipulation under anesthesia
...
```json
{
  ...
  "analysis": "Frozen shoulder (M75.00) with Manipulation under anesthesia is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=M",
    "diagnosis=Frozen shoulder (M75.00)",
    "treatment_requested=Manipulation under anesthesia"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Manipulation under anesthesia is a plausible intervention for Frozen shoulder (M75.00).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Frozen shoulder (M75.00)",
    "Manipulation under anesthesia"
...
```json
{
  "case_id": "case_272_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
