# Gumloop verbose pass — case_404_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** wrong_appeals_contact, algo_boilerplate_fingerprint  
**Profile:** 42F, Carpal tunnel with neurology referral (G56.00), Nerve conduction study and splinting
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Carpal tunnel with neurology referral",
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/08/2026",
    "Date of Service (requested): 02/16/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0104 under Aetna Clinical Policy Bullet",
