# Gumloop verbose pass — case_266_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** algo_reviewer_no_credentials, plan_exclusion_overrides_state_mandate  
**Profile:** 27F, Uterine prolapse, symptomatic (N81.2), Pessary fitting plus surgical consult
...
```json
{
  ...
  "analysis": "Uterine prolapse, symptomatic (N81.2) with Pessary fitting plus surgical consult is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=27",
    "gender=F",
    "diagnosis=Uterine prolapse, symptomatic (N81.2)",
    "treatment_requested=Pessary fitting plus surgical consult"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Pessary fitting plus surgical consult is a plausible intervention for Uterine prolapse, symptomatic (N81.2).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Uterine prolapse, symptomatic (N81.2)",
    "Pessary fitting plus surgical consult"
...
```json
{
  "case_id": "case_266_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
