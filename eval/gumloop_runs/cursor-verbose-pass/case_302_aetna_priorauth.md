# Gumloop verbose pass — case_302_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** wrong_appeals_contact, non_specialist_reviewer  
**Profile:** 42M, Idiopathic intracranial hypertension (G93.2), Optic nerve sheath fenestration
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=M",
    "diagnosis=Idiopathic intracranial hypertension (G93.2)",
    "treatment_requested=Optic nerve sheath fenestration"
  ]
}
```
...
```json
{
  "case_id": "case_302_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
