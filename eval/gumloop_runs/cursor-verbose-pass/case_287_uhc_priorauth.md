# Gumloop verbose pass — case_287_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** algo_boilerplate_fingerprint, missing_iro_notice  
**Profile:** 34F, Major depressive disorder, recurrent, moderate (F33.1), Intensive outpatient program (IOP) for depression
...
```json
{
  "case_id": "case_287_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
