# Gumloop verbose pass — case_489_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** plan_exclusion_overrides_state_mandate, incorrect_demographic_guideline  
**Profile:** 19M, Panic disorder with agoraphobia (F40.01), Psychiatric partial hospitalization
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/01/2026",
    "Date of Service (requested): 01/12/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "rrect demographic guideline). CPB 0109 under Aetna Clinical Policy Bul",
