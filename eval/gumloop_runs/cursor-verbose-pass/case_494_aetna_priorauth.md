# Gumloop verbose pass — case_494_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** algo_boilerplate_fingerprint, non_specialist_reviewer  
**Profile:** 27F, Symptomatic cholelithiasis (K80.20), Laparoscopic cholecystectomy
...
```json
{
  "case_id": "case_494_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
