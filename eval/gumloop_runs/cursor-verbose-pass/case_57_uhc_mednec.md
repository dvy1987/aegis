# Gumloop verbose pass — case_57_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** missing_iro_notice, non_specialist_reviewer  
**Profile:** 49F, Osteoporosis with vertebral fracture (M80.08XA), Denosumab (Prolia)
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "49F with Osteoporosis with vertebral fracture is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 49, \"gender\": \"F\""
  ],
