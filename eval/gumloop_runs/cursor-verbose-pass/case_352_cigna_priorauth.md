# Gumloop verbose pass — case_352_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** algo_reviewer_no_credentials, incorrect_demographic_guideline  
**Profile:** 27M, Post-traumatic stress disorder, chronic (F43.12), Prolonged exposure therapy beyond visit cap
...
```json
{
  "case_id": "case_352_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
