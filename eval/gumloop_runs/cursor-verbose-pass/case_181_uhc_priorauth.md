# Gumloop verbose pass — case_181_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** algo_boilerplate_fingerprint, non_specialist_reviewer  
**Profile:** 49M, Pulmonary embolism, suspected low-intermediate risk (I26.99), CT pulmonary angiography
...
```json
{
  "case_id": "case_181_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
