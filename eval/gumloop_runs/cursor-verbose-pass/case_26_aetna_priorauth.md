# Gumloop verbose pass — case_26_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** wrong_appeals_contact, appeal_closed_as_withdrawn  
**Profile:** 72F, Bipolar II disorder, current depressed episode (F31.81), Partial hospitalization program (PHP)
...
```json
{
  "case_id": "case_26_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
