# Gumloop verbose pass — case_196_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** ignored_physician_letter, wrong_benefit_category  
**Profile:** 27M, Hip pain, non-arthritic suspicion (M25.551), MRI hip without contrast
...
```json
{
  "case_id": "case_196_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
