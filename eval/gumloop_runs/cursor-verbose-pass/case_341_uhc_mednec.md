# Gumloop verbose pass — case_341_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** algo_boilerplate_fingerprint, non_specialist_reviewer  
...
```json
{
  ...
  "evidence_quotes": [
    "age=49",
    "gender=M",
    "diagnosis=Trigeminal neuralgia, classic (G50.0)",
    "treatment_requested=Microvascular decompression referral"
  ]
}
```
