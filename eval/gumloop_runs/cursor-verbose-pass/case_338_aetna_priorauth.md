# Gumloop verbose pass — case_338_aetna_priorauth
...
```json
{
  ...
  "evidence_quotes": [
    "age=27",
    "gender=M",
    "diagnosis=Symptomatic cholelithiasis (K80.20)",
    "treatment_requested=Laparoscopic cholecystectomy"
  ]
}
```
...
```json
{
  "case_id": "case_338_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
