# Gumloop verbose pass — case_110_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** wrong_appeals_contact, plan_exclusion_overrides_state_mandate  
**Profile:** 42F, Symptomatic cholelithiasis (K80.20), Laparoscopic cholecystectomy
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "42F with Symptomatic cholelithiasis is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 42, \"gender\": \"F\""
  ],
...
```json
{
  "case_id": "case_110_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
