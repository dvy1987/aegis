# Gumloop verbose pass — case_317_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** algo_time_delta, experimental_despite_fda_approval  
**Profile:** 19M, Myasthenia gravis, generalized (G70.00), Eculizumab (Soliris)
...
```json
{
  ...
  "evidence_quotes": [
    "age=19",
    "gender=M",
    "diagnosis=Myasthenia gravis, generalized (G70.00)",
    "treatment_requested=Eculizumab (Soliris)"
  ]
}
```
...
```json
{
  ...
  "verification_results": [
    {
      "status": "PRESENT",
      "evidence": "submission_timestamp=2026-03-10T14:00:00Z; denial_timestamp=2026-03-10T14:04:00Z",
