# Gumloop verbose pass — case_198_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** plan_exclusion_overrides_state_mandate, algo_boilerplate_fingerprint  
**Profile:** 65F, Normal pressure hydrocephalus, suspected (G91.2), High-volume lumbar puncture trial
...
```json
{
  "case_id": "case_198_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
