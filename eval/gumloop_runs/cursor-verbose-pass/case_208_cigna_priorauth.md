# Gumloop verbose pass — case_208_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** superseded_guideline, wrong_appeals_contact  
**Profile:** 19M, Post-traumatic stress disorder, chronic (F43.12), Prolonged exposure therapy beyond visit cap
...
```json
{
  "case_id": "case_208_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
