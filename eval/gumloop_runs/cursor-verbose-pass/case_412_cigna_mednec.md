# Gumloop verbose pass — case_412_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** unreasonable_documentation_deadline, missing_cost_liability  
**Profile:** 19F, Hip pain, non-arthritic suspicion (M25.551), MRI hip without contrast
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Hip pain, non-arthritic suspicion",
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Date of Service (requested): 02/24/2026"
  ],
  "improvement": null
}
```
