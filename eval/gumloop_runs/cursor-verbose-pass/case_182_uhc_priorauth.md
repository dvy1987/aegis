# Gumloop verbose pass — case_182_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** contraindication_to_step_therapy, algo_time_delta  
**Profile:** 27M, Headache with new neurologic deficit, subacute (R51.9), MRI brain with and without contrast
...
```json
{
  "case_id": "case_182_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
