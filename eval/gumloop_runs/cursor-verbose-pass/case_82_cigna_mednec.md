# Gumloop verbose pass — case_82_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** wrong_appeals_contact, plan_exclusion_overrides_state_mandate  
**Profile:** 27F, Insomnia disorder, chronic (G47.00), Cognitive behavioral therapy for insomnia (CBT-I), 8 sessions
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "27F with Insomnia disorder, chronic is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 27, \"gender\": \"F\""
  ],
  ...
  "verification_results": [
    {
      ...
      "status": "PRESENT",
      "evidence": "Appeals contact lists implausible fax/PO Box (555-0199 / Lexington box)."
    },
    {
