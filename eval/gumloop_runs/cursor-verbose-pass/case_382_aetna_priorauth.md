# Gumloop verbose pass — case_382_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** missing_erisa_disclosures, superseded_guideline  
**Profile:** 42F, Small fiber neuropathy, idiopathic (G62.89), Skin biopsy for intraepidermal nerve fiber density
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/14/2026",
    "Date of Service (requested): 01/25/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "erseded guideline reference). CPB 0122 under Aetna Clinical Policy Bul",
...
```json
{
  "case_id": "case_382_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
