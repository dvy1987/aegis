# Gumloop verbose pass — case_313_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** experimental_despite_fda_approval, algo_time_delta  
**Profile:** 49F, Polycystic ovary syndrome with hyperandrogenism (E28.2), Spironolactone for androgenic symptoms
...
```json
{
  ...
  "evidence_quotes": [
    "age=49",
    "gender=F",
    "diagnosis=Polycystic ovary syndrome with hyperandrogenism (E28.2)",
    "treatment_requested=Spironolactone for androgenic symptoms"
  ]
}
```
...
```json
{
  "case_id": "case_313_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
