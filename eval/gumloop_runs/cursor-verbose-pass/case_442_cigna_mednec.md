# Gumloop verbose pass — case_442_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** contraindication_to_step_therapy, missing_iro_notice  
**Profile:** 27M, Obesity with BMI 42 and prediabetes (E66.01), GLP-1 receptor agonist (semaglutide 2.4 mg)
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 04/15/2026",
    "Date of Service (requested): 03/26/2026"
  ],
  "improvement": null
}
```
