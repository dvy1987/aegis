# Gumloop verbose pass — case_492_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** non_specialist_reviewer, experimental_despite_fda_approval  
**Profile:** 69M, Heart failure with reduced ejection fraction (I50.20), Cardiac resynchronization therapy (CRT-D)
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0112 under Aetna Clinical Policy Bullet",
