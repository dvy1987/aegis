# Gumloop verbose pass — case_399_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** ignored_physician_letter, experimental_despite_fda_approval  
**Profile:** 19M, Cushing disease, suspected (E24.0), Pituitary MRI with endocrinology referral
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Date of Service (requested): 02/11/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0139 under Aetna Clinical Policy Bullet",
...
```json
{
  "case_id": "case_399_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
