# Gumloop verbose pass — case_316_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** algo_boilerplate_fingerprint, contraindication_to_step_therapy  
**Profile:** 27M, Hip labral tear (M24.151), Hip arthroscopy with labral repair
...
```json
{
  ...
  "analysis": "Hip labral tear (M24.151) with Hip arthroscopy with labral repair is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=27",
    "gender=M",
    "diagnosis=Hip labral tear (M24.151)",
    "treatment_requested=Hip arthroscopy with labral repair"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Hip arthroscopy with labral repair is a plausible intervention for Hip labral tear (M24.151).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Hip labral tear (M24.151)",
    "Hip arthroscopy with labral repair"
