# Gumloop verbose pass — case_384_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, contraindication_to_step_therapy  
**Profile:** 27M, Symptomatic uterine fibroids (D25.9), Myomectomy for fertility preservation
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/16/2026",
    "Date of Service (requested): 01/27/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "ice. Clinical policy applied: CDG-UM124 under UnitedHealthcare Coverag",
    "l before the date of service. Clinical policy applied: CDG-UM124 under"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_384_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
