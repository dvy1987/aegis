# Gumloop verbose pass — case_484_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** algo_boilerplate_fingerprint, superseded_guideline  
**Profile:** 27F, Gynecomastia, persistent adolescent (N62), Subcutaneous mastectomy
...
```json
{
  "case_id": "case_484_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
