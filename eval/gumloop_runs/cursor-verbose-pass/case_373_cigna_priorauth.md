# Gumloop verbose pass — case_373_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** experimental_despite_fda_approval, incorrect_demographic_guideline  
**Profile:** 68F, Severe obsessive-compulsive disorder (F42.2), Transcranial magnetic stimulation (TMS)
...
```json
{
  "case_id": "case_373_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
