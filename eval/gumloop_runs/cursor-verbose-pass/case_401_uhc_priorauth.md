# Gumloop verbose pass — case_401_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** algo_boilerplate_fingerprint, unreasonable_documentation_deadline  
**Profile:** 49F, Compression fracture T12, osteoporotic (M80.08XA), Kyphoplasty
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Compression fracture T12, osteoporotic",
    "Kyphoplasty",
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/05/2026",
    "Date of Service (requested): 02/13/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM101 under UnitedHealthcare Coverage D",
    "Clinical policy applied: CDG-UM101 under UnitedHealthca"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_401_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
