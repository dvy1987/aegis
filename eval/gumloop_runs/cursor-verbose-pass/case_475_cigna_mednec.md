# Gumloop verbose pass — case_475_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** wrong_appeals_contact, algo_time_delta  
**Profile:** 34F, Achilles tendinopathy, chronic (M76.60), Platelet-rich plasma injection
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical policy applied: Coverage Policy 135 under Cign"
  ],
  "improvement": null
}
```
