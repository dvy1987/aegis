# Gumloop verbose pass — case_259_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** missing_cost_liability, plan_exclusion_overrides_state_mandate  
**Profile:** 34M, Graves disease with ophthalmopathy (E05.00), Teprotumumab for thyroid eye disease
...
```json
{
  ...
  "evidence_quotes": [
    "age=34",
    "gender=M",
    "diagnosis=Graves disease with ophthalmopathy (E05.00)",
    "treatment_requested=Teprotumumab for thyroid eye disease"
  ]
}
```
...
```json
{
  "case_id": "case_259_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
