# Gumloop verbose pass — case_237_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** algo_boilerplate_fingerprint, incorrect_demographic_guideline  
**Profile:** 49M, Diabetic gastroparesis (K31.84), Gastric electrical stimulation evaluation
...
```json
{
  ...
  "analysis": "Diabetic gastroparesis (K31.84) with Gastric electrical stimulation evaluation is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Gastric electrical stimulation evaluation is a plausible intervention for Diabetic gastroparesis (K31.84).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Diabetic gastroparesis (K31.84)",
    "Gastric electrical stimulation evaluation"
...
```json
{
  "case_id": "case_237_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
