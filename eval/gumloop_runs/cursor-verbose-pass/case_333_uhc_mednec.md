# Gumloop verbose pass — case_333_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** contraindication_to_step_therapy, wrong_benefit_category  
**Profile:** 34F, Endometrial cancer, high-grade (C54.1), Adjuvant vaginal brachytherapy
...
```json
{
  ...
  "evidence_quotes": [
    "age=34",
    "gender=F",
    "diagnosis=Endometrial cancer, high-grade (C54.1)",
    "treatment_requested=Adjuvant vaginal brachytherapy"
  ]
}
```
