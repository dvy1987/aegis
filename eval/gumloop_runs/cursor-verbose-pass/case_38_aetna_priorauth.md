# Gumloop verbose pass — case_38_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** wrong_appeals_contact, plan_exclusion_overrides_state_mandate  
**Profile:** 19F, Metastatic castration-sensitive prostate cancer (C61), Apalutamide plus androgen deprivation therapy
...
```json
{
  "case_id": "case_38_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
