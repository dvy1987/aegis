# Gumloop verbose pass — case_303_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** timeline_violation, appeal_closed_as_withdrawn  
**Profile:** 19F, Plantar fasciitis, chronic (M72.2), Extracorporeal shock wave therapy
...
```json
{
  ...
  "evidence_quotes": [
    "age=19",
    "gender=F",
    "diagnosis=Plantar fasciitis, chronic (M72.2)",
    "treatment_requested=Extracorporeal shock wave therapy"
  ]
}
```
