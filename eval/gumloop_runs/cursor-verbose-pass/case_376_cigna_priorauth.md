# Gumloop verbose pass — case_376_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** peer_to_peer_window_verbal_only, contraindication_to_step_therapy  
**Profile:** 19F, Type 1 diabetes mellitus (E10.9), Insulin pump upgrade (automated delivery)
...
```json
{
  "case_id": "case_376_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
