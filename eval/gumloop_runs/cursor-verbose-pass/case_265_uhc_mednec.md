# Gumloop verbose pass — case_265_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** appeal_closed_as_withdrawn, non_specialist_reviewer  
**Profile:** 19F, Plaque psoriasis, moderate (L40.0), Adalimumab (Humira)
...
```json
{
  ...
  "evidence_quotes": [
    "age=19",
    "gender=F",
    "diagnosis=Plaque psoriasis, moderate (L40.0)",
    "treatment_requested=Adalimumab (Humira)"
  ]
}
```
