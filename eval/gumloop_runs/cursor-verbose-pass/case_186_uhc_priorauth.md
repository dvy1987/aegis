# Gumloop verbose pass — case_186_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** algo_time_delta, appeal_closed_as_withdrawn  
**Profile:** 27F, Hereditary angioedema (D84.1), Lanadelumab prophylaxis
  ...
  "verification_results": [
    {
      ...
      "status": "PRESENT",
      "evidence": "2.0 min between sub and denial."
    },
    {
...
```json
{
  "case_id": "case_186_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
