# Gumloop verbose pass — case_299_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** non_specialist_reviewer, wrong_appeals_contact  
**Profile:** 34M, Crohn's disease, moderate to severe (K50.90), Ustekinumab (Stelara) maintenance infusion
...
```json
{
  ...
  "evidence_quotes": [
    "age=34",
    "gender=M",
    "diagnosis=Crohn's disease, moderate to severe (K50.90)",
    "treatment_requested=Ustekinumab (Stelara) maintenance infusion"
  ]
}
```
