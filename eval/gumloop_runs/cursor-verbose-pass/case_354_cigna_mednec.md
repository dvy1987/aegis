# Gumloop verbose pass — case_354_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** experimental_despite_fda_approval, contraindication_to_step_therapy  
**Profile:** 19F, Carpal tunnel syndrome, severe (G56.00), Carpal tunnel release
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 05/17/2026",
    "Date of Service (requested): 04/27/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical policy applied: Coverage Policy 134 under Cign"
  ],
  "improvement": null
}
```
