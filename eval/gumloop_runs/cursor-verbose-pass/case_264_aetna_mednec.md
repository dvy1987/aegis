# Gumloop verbose pass — case_264_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** experimental_despite_fda_approval, appeal_closed_as_withdrawn  
**Profile:** 27M, Heart failure with reduced ejection fraction (I50.20), Cardiac resynchronization therapy (CRT-D)
...
```json
{
  ...
  "analysis": "Heart failure with reduced ejection fraction (I50.20) with Cardiac resynchronization therapy (CRT-D) is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=27",
    "gender=M",
    "diagnosis=Heart failure with reduced ejection fraction (I50.20)",
    "treatment_requested=Cardiac resynchronization therapy (CRT-D)"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Cardiac resynchronization therapy (CRT-D) is a plausible intervention for Heart failure with reduced ejection fraction (I50.20).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Heart failure with reduced ejection fraction (I50.20)",
    "Cardiac resynchronization therapy (CRT-D)"
