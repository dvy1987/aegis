# Gumloop verbose pass — case_269_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** missing_erisa_disclosures, wrong_benefit_category  
**Profile:** 34F, Alcohol use disorder, severe (F10.20), Inpatient medical detoxification (3–5 days)
...
```json
{
  "case_id": "case_269_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
