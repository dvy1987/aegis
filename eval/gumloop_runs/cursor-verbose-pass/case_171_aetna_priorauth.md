# Gumloop verbose pass — case_171_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** non_specialist_reviewer, wrong_benefit_category  
**Profile:** 49M, Parkinson disease, motor fluctuations (G20), Duopa pump evaluation
...
```json
{
  "case_id": "case_171_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
