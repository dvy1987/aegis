# Gumloop verbose pass — case_416_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** appeal_closed_as_withdrawn, algo_boilerplate_fingerprint  
**Profile:** 57M, Frozen shoulder (M75.00), Manipulation under anesthesia
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/20/2026",
    "Date of Service (requested): 02/28/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM116 under UnitedHealthcare Coverage D",
    "Clinical policy applied: CDG-UM116 under UnitedHealthca"
  ],
  "improvement": null
}
```
