# Gumloop verbose pass — case_390_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** algo_boilerplate_fingerprint, plan_exclusion_overrides_state_mandate  
**Profile:** 42F, Menorrhagia due to adenomyosis (N80.0), Endometrial ablation
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/22/2026",
    "Date of Service (requested): 02/02/2026"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_390_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
