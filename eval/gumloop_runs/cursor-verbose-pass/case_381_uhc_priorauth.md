# Gumloop verbose pass — case_381_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** timeline_violation, ignored_physician_letter  
**Profile:** 49F, Hypertrophic cardiomyopathy (I42.2), Septal myectomy evaluation
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM121 under UnitedHealthcare Coverage D",
    "Clinical policy applied: CDG-UM121 under UnitedHealthca"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_381_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
