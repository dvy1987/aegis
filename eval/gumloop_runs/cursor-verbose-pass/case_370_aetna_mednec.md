# Gumloop verbose pass — case_370_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** missing_erisa_disclosures, superseded_guideline  
**Profile:** 27F, Dermatomyositis with weakness (M33.10), IV immunoglobulin (IVIG)
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "erseded guideline reference). CPB 0110 under Aetna Clinical Policy Bul",
