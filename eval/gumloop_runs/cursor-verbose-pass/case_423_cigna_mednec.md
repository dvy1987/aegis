# Gumloop verbose pass — case_423_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** experimental_despite_fda_approval, peer_to_peer_window_verbal_only  
**Profile:** 67F, Familial hypercholesterolemia (E78.01), PCSK9 inhibitor (evolocumab)
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/27/2026",
    "Date of Service (requested): 03/07/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical policy applied: Coverage Policy 123 under Cign"
  ],
  "improvement": null
}
```
