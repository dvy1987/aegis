# Gumloop verbose pass — case_476_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** mhpaea_level_of_care_asymmetry, missing_iro_notice  
**Profile:** 27nonbinary, Social anxiety disorder, severe (F40.10), Group cognitive behavioral therapy (16 sessions)
...
```json
{
  ...
  "analysis": "Social anxiety disorder, severe (F40.10) with Group cognitive behavioral therapy (16 sessions) is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Group cognitive behavioral therapy (16 sessions) is a plausible intervention for Social anxiety disorder, severe (F40.10).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 05/19/2026",
    "Date of Service (requested): 04/29/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "ice. Clinical policy applied: CDG-UM136 under UnitedHealthcare Coverag",
    "l before the date of service. Clinical policy applied: CDG-UM136 under"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_476_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
