# Gumloop verbose pass — case_491_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** incorrect_demographic_guideline, algo_time_delta  
**Profile:** 49F, Major depressive disorder, recurrent, moderate (F33.1), Intensive outpatient program (IOP) for depression
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "rrect demographic guideline). CDG-UM111 under UnitedHealthcare Coverag",
...
```json
{
  "case_id": "case_491_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
