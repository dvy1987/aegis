# Gumloop verbose pass — case_385_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** wrong_appeals_contact, peer_to_peer_window_verbal_only  
**Profile:** 61M, Diffuse large B-cell lymphoma (C83.30), R-CHOP cycle continuation
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/17/2026",
    "Date of Service (requested): 01/28/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical policy applied: Coverage Policy 125 under Cign"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_385_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
