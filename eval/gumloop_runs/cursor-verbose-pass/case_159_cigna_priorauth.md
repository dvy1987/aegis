# Gumloop verbose pass — case_159_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** algo_reviewer_no_credentials, superseded_guideline  
**Profile:** 34M, Plantar fasciitis, chronic (M72.2), Extracorporeal shock wave therapy
...
```json
{
  "case_id": "case_159_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
