# Gumloop verbose pass — case_392_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** non_specialist_reviewer, appeal_closed_as_withdrawn  
**Profile:** 58F, Frozen shoulder (M75.00), Manipulation under anesthesia
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/24/2026",
    "Date of Service (requested): 02/04/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM132 under UnitedHealthcare Coverage D",
    "Clinical policy applied: CDG-UM132 under UnitedHealthca"
  ],
  "improvement": null
}
```
