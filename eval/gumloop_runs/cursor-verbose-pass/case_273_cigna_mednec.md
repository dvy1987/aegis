# Gumloop verbose pass — case_273_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** superseded_guideline, missing_erisa_disclosures  
**Profile:** 34M, Hypertrophic cardiomyopathy (I42.2), Septal myectomy evaluation
...
```json
{
  ...
  "evidence_quotes": [
    "age=34",
    "gender=M",
    "diagnosis=Hypertrophic cardiomyopathy (I42.2)",
    "treatment_requested=Septal myectomy evaluation"
  ]
}
```
