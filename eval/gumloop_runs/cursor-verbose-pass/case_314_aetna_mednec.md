# Gumloop verbose pass — case_314_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** superseded_guideline, experimental_despite_fda_approval  
**Profile:** 42M, Relapsing multiple sclerosis (G35), Ocrelizumab infusion
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=M",
    "diagnosis=Relapsing multiple sclerosis (G35)",
    "treatment_requested=Ocrelizumab infusion"
  ]
}
```
