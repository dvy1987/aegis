# Gumloop verbose pass — case_355_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** wrong_benefit_category, timeline_violation  
**Profile:** 59F, Vulvodynia, generalized (N94.818), Vulvar vestibulitis physical therapy protocol
...
```json
{
  ...
  "analysis": "Vulvodynia, generalized (N94.818) with Vulvar vestibulitis physical therapy protocol is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Vulvar vestibulitis physical therapy protocol is a plausible intervention for Vulvodynia, generalized (N94.818).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM135 under UnitedHealthcare Coverage D",
    "Clinical policy applied: CDG-UM135 under UnitedHealthca"
  ],
  "improvement": null
}
```
