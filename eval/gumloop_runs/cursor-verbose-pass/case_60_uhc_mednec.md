# Gumloop verbose pass — case_60_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** missing_iro_notice, incorrect_demographic_guideline  
**Profile:** 42F, Rotator cuff tear, full-thickness (M75.101), Arthroscopic rotator cuff repair
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "42F with Rotator cuff tear, full-thickness is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 42, \"gender\": \"F\""
  ],
