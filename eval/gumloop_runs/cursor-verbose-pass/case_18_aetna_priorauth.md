# Gumloop verbose pass — case_18_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** incorrect_demographic_guideline, plan_exclusion_overrides_state_mandate  
**Profile:** 42F, Polycystic ovary syndrome with infertility (E28.2), Letrozole ovulation induction
...
```json
{
  "case_id": "case_18_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
