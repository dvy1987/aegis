# Gumloop verbose pass — case_393_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, algo_time_delta  
**Profile:** 19M, Endometrial cancer, high-grade (C54.1), Adjuvant vaginal brachytherapy
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "ice. Clinical policy applied: CDG-UM133 under UnitedHealthcare Coverag",
    "l before the date of service. Clinical policy applied: CDG-UM133 under"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_393_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
