# Gumloop verbose pass — case_361_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** non_specialist_reviewer, peer_to_peer_window_verbal_only  
**Profile:** 49M, Polycystic ovary syndrome with hyperandrogenism (E28.2), Spironolactone for androgenic symptoms
...
```json
{
  "case_id": "case_361_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
