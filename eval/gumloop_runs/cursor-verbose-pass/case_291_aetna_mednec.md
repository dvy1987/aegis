# Gumloop verbose pass — case_291_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** algo_reviewer_no_credentials, ignored_physician_letter  
**Profile:** 19F, Attention-deficit/hyperactivity disorder, combined (F90.2), Adult ADHD coaching plus medication management extension
...
```json
{
  ...
  "evidence_quotes": [
    "age=19",
    "gender=F",
    "diagnosis=Attention-deficit/hyperactivity disorder, combined (F90.2)",
    "treatment_requested=Adult ADHD coaching plus medication management extension"
  ]
}
```
