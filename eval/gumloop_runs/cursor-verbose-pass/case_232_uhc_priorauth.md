# Gumloop verbose pass — case_232_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** unreasonable_documentation_deadline, algo_time_delta  
**Profile:** 19F, Symptomatic aortic stenosis, moderate (I35.0), Transcatheter aortic valve replacement (TAVR) evaluation
...
```json
{
  ...
  "verification_results": [
    ...
    },
    {
      ...
      "status": "PRESENT",
      "evidence": "3.0 min between sub and denial."
    }
  ],
  "score": 1,
  "confidence": 0.9,
...
```json
{
  "case_id": "case_232_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
