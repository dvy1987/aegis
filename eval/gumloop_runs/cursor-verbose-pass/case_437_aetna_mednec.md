# Gumloop verbose pass — case_437_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** missing_erisa_disclosures, algo_boilerplate_fingerprint  
**Profile:** 49F, Myasthenia gravis, generalized (G70.00), Eculizumab (Soliris)
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 04/10/2026",
    "Date of Service (requested): 03/21/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0137 under Aetna Clinical Policy Bullet",
