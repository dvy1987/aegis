# Gumloop verbose pass — case_220_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** algo_time_delta, circular_medical_necessity  
**Profile:** 67M, Male hypogonadism (E29.1), Testosterone cypionate with monitoring
  ...
  "verification_results": [
    {
      ...
      "status": "PRESENT",
      "evidence": "4.0 min between sub and denial."
    },
    {
...
```json
{
  "case_id": "case_220_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
