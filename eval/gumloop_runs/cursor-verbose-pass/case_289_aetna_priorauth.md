# Gumloop verbose pass — case_289_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, superseded_guideline  
**Profile:** 65M, Focal epilepsy, drug-resistant (G40.019), Lacosamide add-on therapy
...
```json
{
  ...
  "evidence_quotes": [
    "age=65",
    "gender=M",
    "diagnosis=Focal epilepsy, drug-resistant (G40.019)",
    "treatment_requested=Lacosamide add-on therapy"
  ]
}
```
...
```json
{
  "case_id": "case_289_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
