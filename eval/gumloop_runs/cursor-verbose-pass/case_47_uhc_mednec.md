# Gumloop verbose pass — case_47_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** ignored_physician_letter, missing_iro_notice  
**Profile:** 34F, Crohn's disease, moderate to severe (K50.90), Ustekinumab (Stelara) maintenance infusion
...
```json
{
  ...
  "analysis": "Crohn's disease, moderate to severe (K50.90) with Ustekinumab (Stelara) maintenance infusion is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Ustekinumab (Stelara) maintenance infusion is a plausible intervention for Crohn's disease, moderate to severe (K50.90).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Crohn's disease, moderate to severe (K50.90)",
    "Ustekinumab (Stelara) maintenance infusion"
...
```json
{
  ...
  "score": 1,
  "confidence": 0.93,
  "improvement": "MISSING FLAW: Pattern 'ignored_physician_letter' \u2014 remove 'documentation submitted' and 'clinical notes reviewed'; deny without acknowledging submitted Crohn's records."
}
```
...
```json
{
  ...
  "suggested_revisions": [
    "MISSING FLAW: Pattern 'ignored_physician_letter' \u2014 remove 'documentation submitted' and 'clinical notes reviewed'; deny without acknowledging submitted Crohn's records."
  ]
}
```
