# Gumloop verbose pass — case_120_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** experimental_despite_fda_approval, superseded_guideline  
**Profile:** 19F, Symptomatic uterine fibroids (D25.9), Myomectomy for fertility preservation
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "19F with Symptomatic uterine fibroids is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 19, \"gender\": \"F\""
  ],
