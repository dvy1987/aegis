# Gumloop verbose pass — case_347_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** contraindication_to_step_therapy, experimental_despite_fda_approval  
**Profile:** 49F, Chronic migraine without aura (G43.709), Erenumab (Aimovig) preventive therapy
...
```json
{
  ...
  "analysis": "Chronic migraine without aura (G43.709) with Erenumab (Aimovig) preventive therapy is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "treatment_requested=Erenumab (Aimovig) preventive therapy"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Erenumab (Aimovig) preventive therapy is a plausible intervention for Chronic migraine without aura (G43.709).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Chronic migraine without aura (G43.709)",
    "Erenumab (Aimovig) preventive therapy"
...
```json
{
  "case_id": "case_347_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
