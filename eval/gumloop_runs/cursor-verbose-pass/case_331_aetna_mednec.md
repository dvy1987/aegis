# Gumloop verbose pass — case_331_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** plan_exclusion_overrides_state_mandate, missing_erisa_disclosures  
**Profile:** 49F, Achilles tendinopathy, chronic (M76.60), Platelet-rich plasma injection
...
```json
{
  ...
  "analysis": "Achilles tendinopathy, chronic (M76.60) with Platelet-rich plasma injection is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=49",
    "gender=F",
    "diagnosis=Achilles tendinopathy, chronic (M76.60)",
    "treatment_requested=Platelet-rich plasma injection"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Platelet-rich plasma injection is a plausible intervention for Achilles tendinopathy, chronic (M76.60).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Achilles tendinopathy, chronic (M76.60)",
    "Platelet-rich plasma injection"
