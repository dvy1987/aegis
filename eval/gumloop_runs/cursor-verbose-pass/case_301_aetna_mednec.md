# Gumloop verbose pass — case_301_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** wrong_appeals_contact, plan_exclusion_overrides_state_mandate  
**Profile:** 34F, Deviated nasal septum with obstruction (J34.2), Septoplasty
...
```json
{
  ...
  "evidence_quotes": [
    "age=34",
    "gender=F",
    "diagnosis=Deviated nasal septum with obstruction (J34.2)",
    "treatment_requested=Septoplasty"
  ]
}
```
