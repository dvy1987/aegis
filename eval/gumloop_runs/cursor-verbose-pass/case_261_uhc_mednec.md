# Gumloop verbose pass — case_261_uhc_mednec
...
```json
{
  ...
  "evidence_quotes": [
    "age=19",
    "gender=M",
    "diagnosis=Post-concussion syndrome (G44.309)",
    "treatment_requested=Multidisciplinary concussion clinic program"
  ]
}
```
