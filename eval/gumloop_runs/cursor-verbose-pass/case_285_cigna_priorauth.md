# Gumloop verbose pass — case_285_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** superseded_guideline, experimental_despite_fda_approval  
**Profile:** 63F, Shoulder instability MRI (M25.311), MRI shoulder without contrast
...
```json
{
  ...
  "analysis": "Shoulder instability MRI (M25.311) with MRI shoulder without contrast is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=63",
    "gender=F",
    "diagnosis=Shoulder instability MRI (M25.311)",
    "treatment_requested=MRI shoulder without contrast"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "MRI shoulder without contrast is a plausible intervention for Shoulder instability MRI (M25.311).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Shoulder instability MRI (M25.311)",
    "MRI shoulder without contrast"
...
```json
{
  "case_id": "case_285_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
