# Gumloop verbose pass — case_136_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** plan_exclusion_overrides_state_mandate, missing_erisa_disclosures  
**Profile:** 27M, Primary dysmenorrhea, severe (N94.4), Hormonal IUD (levonorgestrel 52 mg)
...
```json
{
  ...
  "analysis": "Primary dysmenorrhea, severe (N94.4) with Hormonal IUD (levonorgestrel 52 mg) is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "27M with Primary dysmenorrhea, severe is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 27, \"gender\": \"M\""
  ],
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Hormonal IUD (levonorgestrel 52 mg) is a plausible intervention for Primary dysmenorrhea, severe (N94.4).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Primary dysmenorrhea, severe (N94.4)",
    "Hormonal IUD (levonorgestrel 52 mg)"
...
```json
{
  ...
  "verification_results": [
    ...
    },
    {
      ...
      "status": "PRESENT",
      "evidence": "Missing ERISA element(s): external review and/or \u00a7502(a) civil action."
    }
  ],
  "score": 5,
  "confidence": 0.93,
