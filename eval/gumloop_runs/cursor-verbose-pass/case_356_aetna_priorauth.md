# Gumloop verbose pass — case_356_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** plan_exclusion_overrides_state_mandate, wrong_appeals_contact  
**Profile:** 66F, Post-MI ventricular tachycardia (I25.2), Subcutaneous ICD
...
```json
{
  ...
  "analysis": "Post-MI ventricular tachycardia (I25.2) with Subcutaneous ICD is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Subcutaneous ICD is a plausible intervention for Post-MI ventricular tachycardia (I25.2).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0136 under Aetna Clinical Policy Bullet",
...
```json
{
  "case_id": "case_356_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
