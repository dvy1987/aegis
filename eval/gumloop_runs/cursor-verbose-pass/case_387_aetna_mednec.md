# Gumloop verbose pass — case_387_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** algo_boilerplate_fingerprint, ignored_physician_letter  
**Profile:** 72F, Recurrent bacterial vaginosis (N76.0), Extended suppressive metronidazole course
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/19/2026",
    "Date of Service (requested): 01/30/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0127 under Aetna Clinical Policy Bullet",
