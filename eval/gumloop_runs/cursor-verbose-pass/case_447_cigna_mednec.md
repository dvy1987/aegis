# Gumloop verbose pass — case_447_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** missing_cost_liability, contraindication_to_step_therapy  
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 04/20/2026",
    "Date of Service (requested): 03/31/2026"
  ],
  "improvement": null
}
```
