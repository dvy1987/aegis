# Gumloop verbose pass — case_290_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** non_specialist_reviewer, algo_boilerplate_fingerprint  
**Profile:** 42M, Metastatic castration-sensitive prostate cancer (C61), Apalutamide plus androgen deprivation therapy
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=M",
    "diagnosis=Metastatic castration-sensitive prostate cancer (C61)",
    "treatment_requested=Apalutamide plus androgen deprivation therapy"
  ]
}
```
