# Gumloop verbose pass — case_73_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, algo_reviewer_no_credentials  
**Profile:** 34F, Pulmonary embolism, suspected low-intermediate risk (I26.99), CT pulmonary angiography
...
```json
{
  ...
  "analysis": "Pulmonary embolism, suspected low-intermediate risk (I26.99) with CT pulmonary angiography is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "34F with Pulmonary embolism, suspected low-intermediate risk is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 34, \"gender\": \"F\""
  ],
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "CT pulmonary angiography is a plausible intervention for Pulmonary embolism, suspected low-intermediate risk (I26.99).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Pulmonary embolism, suspected low-intermediate risk (I26.99)",
    "CT pulmonary angiography"
...
```json
{
  "case_id": "case_73_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
