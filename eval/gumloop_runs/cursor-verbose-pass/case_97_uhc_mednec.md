# Gumloop verbose pass — case_97_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** timeline_violation, incorrect_demographic_guideline  
**Profile:** 19M, Severe obsessive-compulsive disorder (F42.2), Transcranial magnetic stimulation (TMS)
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "19M with Severe obsessive-compulsive disorder is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 19, \"gender\": \"M\""
  ],
