# Gumloop verbose pass — case_300_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** mhpaea_step_therapy_asymmetry, algo_boilerplate_fingerprint  
**Profile:** 42M, Generalized anxiety disorder (F41.1), Additional psychotherapy visits beyond plan annual limit
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "treatment_requested=Additional psychotherapy visits beyond plan annual limit"
  ]
}
```
...
```json
{
  ...
  "verification_results": [
    {
      "status": "PRESENT",
      "evidence": "MHPAEA-style behavioral health asymmetry language (mhpaea_step_therapy_asymmetry).",
      "pattern_id": "mhpaea_step_therapy_asymmetry"
    },
    {
      "status": "PRESENT",
...
```json
{
  ...
  "exploitable_weaknesses": [
    "Pattern anchor: mhpaea_step_therapy_asymmetry",
...
```json
{
  "case_id": "case_300_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
