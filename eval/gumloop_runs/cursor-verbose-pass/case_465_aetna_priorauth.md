# Gumloop verbose pass — case_465_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** non_specialist_reviewer, wrong_benefit_category  
**Profile:** 62F, Osteoporosis with vertebral fracture (M80.08XA), Denosumab (Prolia)
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Date of Service (requested): 04/18/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0125 under Aetna Clinical Policy Bullet",
...
```json
{
  "case_id": "case_465_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
