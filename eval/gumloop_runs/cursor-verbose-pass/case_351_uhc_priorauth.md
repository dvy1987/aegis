# Gumloop verbose pass — case_351_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** wrong_benefit_category, contraindication_to_step_therapy  
**Profile:** 49F, Plantar fasciitis, chronic (M72.2), Extracorporeal shock wave therapy
...
```json
{
  ...
  "analysis": "Plantar fasciitis, chronic (M72.2) with Extracorporeal shock wave therapy is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Extracorporeal shock wave therapy is a plausible intervention for Plantar fasciitis, chronic (M72.2).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 05/14/2026",
    "Date of Service (requested): 04/24/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM131 under UnitedHealthcare Coverage D",
    "Clinical policy applied: CDG-UM131 under UnitedHealthca"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_351_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
