# Gumloop verbose pass — case_462_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** contraindication_to_step_therapy, algo_time_delta  
**Profile:** 19F, Adrenal insufficiency, primary (E27.1), Hydrocortisone stress-dose education plus ACTH stim retest
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical policy applied: Coverage Policy 122 under Cign"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_462_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
