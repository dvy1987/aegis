# Gumloop verbose pass — case_367_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** superseded_guideline, plan_exclusion_overrides_state_mandate  
**Profile:** 34M, Scrotal pain, rule out torsion vs epididymitis (N50.9), Scrotal ultrasound with Doppler
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical criteria applied: InterQual criteria (2018) and/or older MCG "
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_367_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
