# Gumloop verbose pass — case_421_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** algo_time_delta, plan_exclusion_overrides_state_mandate  
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical policy applied: Coverage Policy 121 under Cign"
  ],
  "improvement": null
}
```
  ...
  "verification_results": [
    {
      ...
      "status": "PRESENT",
      "evidence": "Timestamps present: sub=2026-03-10T14:00:00Z, den=2026-03-10T14:03:00Z."
    },
    {
