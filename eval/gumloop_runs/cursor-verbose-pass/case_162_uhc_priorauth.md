# Gumloop verbose pass — case_162_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** unreasonable_documentation_deadline, mhpaea_level_of_care_asymmetry  
**Profile:** 72F, Binge-eating disorder (F50.81), Adjunct lisdexamfetamine for BED
...
```json
{
  "case_id": "case_162_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
