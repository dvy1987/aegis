# Gumloop verbose pass — case_96_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** appeal_closed_as_withdrawn, missing_iro_notice  
**Profile:** 27F, Symptomatic uterine fibroids (D25.9), Myomectomy for fertility preservation
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "27F with Symptomatic uterine fibroids is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 27, \"gender\": \"F\""
  ],
