# Gumloop verbose pass — case_418_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** wrong_appeals_contact, mhpaea_visit_limit_asymmetry  
**Profile:** 27M, Insomnia disorder, chronic (G47.00), Cognitive behavioral therapy for insomnia (CBT-I), 8 sessions
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/22/2026",
    "Date of Service (requested): 03/02/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical policy applied: Coverage Policy 118 under Cign"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "verification_results": [
    ...
    },
    {
      ...
      "status": "PRESENT",
      "evidence": "Behavioral-health visit limit asymmetry language present."
    }
  ],
  "score": 5,
  "confidence": 0.93,
