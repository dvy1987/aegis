# Gumloop verbose pass — case_123_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** ignored_physician_letter, algo_boilerplate_fingerprint  
**Profile:** 34F, Psoriatic arthritis (L40.50), Secukinumab (Cosentyx)
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "34F with Psoriatic arthritis is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 34, \"gender\": \"F\""
  ],
