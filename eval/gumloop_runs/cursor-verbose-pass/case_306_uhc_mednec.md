# Gumloop verbose pass — case_306_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** mhpaea_level_of_care_asymmetry, peer_to_peer_window_verbal_only  
**Profile:** 42F, Binge-eating disorder (F50.81), Adjunct lisdexamfetamine for BED
...
```json
{
  ...
  "analysis": "Binge-eating disorder (F50.81) with Adjunct lisdexamfetamine for BED is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=F",
    "diagnosis=Binge-eating disorder (F50.81)",
    "treatment_requested=Adjunct lisdexamfetamine for BED"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Adjunct lisdexamfetamine for BED is a plausible intervention for Binge-eating disorder (F50.81).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Binge-eating disorder (F50.81)",
    "Adjunct lisdexamfetamine for BED"
...
```json
{
  ...
  "denial_pattern_sources_found": [
    "mhpaea_level_of_care_asymmetry",
    "peer_to_peer_window_verbal_only"
  ],
  "verification_results": [
    {
      "status": "AMBIGUOUS",
      "evidence": "MHPAEA-style behavioral health asymmetry language (mhpaea_level_of_care_asymmetry).",
      "pattern_id": "mhpaea_level_of_care_asymmetry"
    },
    {
      "status": "ABSENT",
  ...
  "score": 1,
  "confidence": 0.87,
  "improvement": "MISSING FLAW: Pattern 'peer_to_peer_window_verbal_only' \u2014 inject per gumloop/prompts/18_flaw_injection_verifier.txt guidance."
}
```
...
```json
{
  ...
  "exploitable_weaknesses": [
    ...
    "Pattern anchor: mhpaea_level_of_care_asymmetry",
...
```json
{
  ...
  "suggested_revisions": [
    "MISSING FLAW: Pattern 'peer_to_peer_window_verbal_only' \u2014 inject per gumloop/prompts/18_flaw_injection_verifier.txt guidance."
  ]
}
```
