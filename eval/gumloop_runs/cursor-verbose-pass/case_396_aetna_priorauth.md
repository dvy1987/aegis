# Gumloop verbose pass — case_396_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** wrong_appeals_contact, incorrect_demographic_guideline  
**Profile:** 42M, Relapsing-remitting multiple sclerosis (G35), Ocrelizumab continuation beyond policy duration cap
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/28/2026",
    "Date of Service (requested): 02/08/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "rrect demographic guideline). CPB 0136 under Aetna Clinical Policy Bul",
...
```json
{
  "case_id": "case_396_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
