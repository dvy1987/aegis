# Gumloop verbose pass — case_103_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** ignored_physician_letter, missing_iro_notice  
**Profile:** 63M, Restless legs syndrome, refractory (G25.81), Pramipexole titration
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "63M with Restless legs syndrome, refractory is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 63, \"gender\": \"M\""
  ],
