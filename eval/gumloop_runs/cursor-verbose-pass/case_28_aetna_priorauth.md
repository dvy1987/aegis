# Gumloop verbose pass — case_28_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** appeal_closed_as_withdrawn, wrong_appeals_contact  
**Profile:** 58F, Non-small cell lung cancer, stage IV EGFR+ (C34.90), Osimertinib third-line after T790M-negative progression
...
```json
{
  "case_id": "case_28_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
  "reason": "All Tier 1 PASS; all intended flaws verified.",
  "tier_1_failures": [],
  "tier_2_failures": [],
  "suggested_revisions": []
}
