# Gumloop verbose pass — case_500_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** superseded_guideline, missing_cost_liability  
**Profile:** 42F, Pancreatic adenocarcinoma, borderline resectable (C25.9), Neoadjuvant FOLFIRINOX
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/12/2026",
    "Date of Service (requested): 01/23/2026"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_500_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
