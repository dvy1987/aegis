# Gumloop verbose pass — case_364_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** missing_erisa_disclosures, ignored_physician_letter  
**Profile:** 19M, Amyotrophic lateral sclerosis (G12.21), Riluzole and multidisciplinary ALS clinic
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 01/27/2026",
    "Date of Service (requested): 01/07/2026"
  ],
  "improvement": null
}
```
