# Gumloop verbose pass — case_309_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** timeline_violation, incorrect_demographic_guideline  
**Profile:** 19F, Chronic sinusitis (J32.9), Functional endoscopic sinus surgery
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "treatment_requested=Functional endoscopic sinus surgery"
  ]
}
```
