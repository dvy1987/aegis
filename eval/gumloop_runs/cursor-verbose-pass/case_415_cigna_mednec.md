# Gumloop verbose pass — case_415_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** algo_reviewer_no_credentials, wrong_appeals_contact  
**Profile:** 72M, Pulmonary arterial hypertension, suspected (I27.0), Right heart catheterization
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/19/2026",
    "Date of Service (requested): 02/27/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical policy applied: Coverage Policy 115 under Cign"
  ],
  "improvement": null
}
```
