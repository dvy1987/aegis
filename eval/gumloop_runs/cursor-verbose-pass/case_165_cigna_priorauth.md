# Gumloop verbose pass — case_165_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** missing_cost_liability, contraindication_to_step_therapy  
**Profile:** 68M, Osteoporosis with vertebral fracture (M80.08XA), Denosumab (Prolia)
...
```json
{
  "case_id": "case_165_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
