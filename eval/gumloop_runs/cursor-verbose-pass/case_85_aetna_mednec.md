# Gumloop verbose pass — case_85_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** plan_exclusion_overrides_state_mandate, missing_erisa_disclosures  
**Profile:** 19F, Diffuse large B-cell lymphoma (C83.30), R-CHOP cycle continuation
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "19F with Diffuse large B-cell lymphoma is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 19, \"gender\": \"F\""
  ],
