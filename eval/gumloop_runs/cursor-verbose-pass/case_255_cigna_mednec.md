# Gumloop verbose pass — case_255_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** missing_cost_liability, algo_time_delta  
**Profile:** 49F, Incidental adrenal nodule 2.8 cm (E27.8), Adrenal protocol CT
...
```json
{
  ...
  "analysis": "Incidental adrenal nodule 2.8 cm (E27.8) with Adrenal protocol CT is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=49",
    "gender=F",
    "diagnosis=Incidental adrenal nodule 2.8 cm (E27.8)",
    "treatment_requested=Adrenal protocol CT"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Adrenal protocol CT is a plausible intervention for Incidental adrenal nodule 2.8 cm (E27.8).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Incidental adrenal nodule 2.8 cm (E27.8)",
    "Adrenal protocol CT"
...
```json
{
  ...
  "verification_results": [
    ...
    {
      "status": "PRESENT",
      "evidence": "submission_timestamp=2026-03-10T14:00:00Z; denial_timestamp=2026-03-10T14:02:00Z",
