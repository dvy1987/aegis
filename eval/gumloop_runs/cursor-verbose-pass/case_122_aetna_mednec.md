# Gumloop verbose pass — case_122_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** algo_boilerplate_fingerprint, appeal_closed_as_withdrawn  
**Profile:** 72M, Symptomatic cholelithiasis (K80.20), Laparoscopic cholecystectomy
...
```json
{
  ...
  "analysis": "Symptomatic cholelithiasis (K80.20) with Laparoscopic cholecystectomy is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "72M with Symptomatic cholelithiasis is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 72, \"gender\": \"M\""
  ],
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Laparoscopic cholecystectomy is a plausible intervention for Symptomatic cholelithiasis (K80.20).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Symptomatic cholelithiasis (K80.20)",
    "Laparoscopic cholecystectomy"
