# Gumloop verbose pass — case_394_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** algo_time_delta, missing_iro_notice  
**Profile:** 27M, Sinus headache with vision changes (G44.1), MRI orbits and brain
...
```json
{
  ...
  "analysis": "Sinus headache with vision changes (G44.1) with MRI orbits and brain is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
    "Sinus headache with vision changes",
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "MRI orbits and brain is a plausible intervention for Sinus headache with vision changes (G44.1).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  "case_id": "case_394_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
