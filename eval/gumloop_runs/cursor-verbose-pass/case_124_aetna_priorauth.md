# Gumloop verbose pass — case_124_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** superseded_guideline, wrong_benefit_category  
**Profile:** 27M, Non-small cell lung cancer, stage IV EGFR+ (C34.90), Osimertinib third-line after T790M-negative progression
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "27M with Non-small cell lung cancer, stage IV EGFR+ is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 27, \"gender\": \"M\""
  ],
...
```json
{
  "case_id": "case_124_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
