# Gumloop verbose pass — case_254_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** algo_boilerplate_fingerprint, appeal_closed_as_withdrawn  
**Profile:** 42F, Cervical spondylosis with radiculopathy (M47.22), Anterior cervical discectomy and fusion C5-6
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=F",
    "diagnosis=Cervical spondylosis with radiculopathy (M47.22)",
    "treatment_requested=Anterior cervical discectomy and fusion C5-6"
  ]
}
```
...
```json
{
  "case_id": "case_254_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
