# Gumloop verbose pass — case_245_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** wrong_benefit_category, non_specialist_reviewer  
**Profile:** 69nonbinary, Osteoporosis, postmenopausal (M81.0), Teriparatide anabolic therapy
...
```json
{
  ...
  "analysis": "Osteoporosis, postmenopausal (M81.0) with Teriparatide anabolic therapy is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Teriparatide anabolic therapy is a plausible intervention for Osteoporosis, postmenopausal (M81.0).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Osteoporosis, postmenopausal (M81.0)",
    "Teriparatide anabolic therapy"
