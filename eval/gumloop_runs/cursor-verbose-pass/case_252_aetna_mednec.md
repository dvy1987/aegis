# Gumloop verbose pass — case_252_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** incorrect_demographic_guideline, plan_exclusion_overrides_state_mandate  
**Profile:** 19M, Rotator cuff tear, full-thickness (M75.101), Arthroscopic rotator cuff repair
...
```json
{
  ...
  "evidence_quotes": [
    "age=19",
    "gender=M",
    "diagnosis=Rotator cuff tear, full-thickness (M75.101)",
    "treatment_requested=Arthroscopic rotator cuff repair"
  ]
}
```
