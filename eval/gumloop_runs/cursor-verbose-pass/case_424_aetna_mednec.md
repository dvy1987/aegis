# Gumloop verbose pass — case_424_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** non_specialist_reviewer, experimental_despite_fda_approval  
**Profile:** 42M, Symptomatic aortic stenosis, moderate (I35.0), Transcatheter aortic valve replacement (TAVR) evaluation
...
```json
{
  ...
  "analysis": "Symptomatic aortic stenosis, moderate (I35.0) with Transcatheter aortic valve replacement (TAVR) evaluation is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
    "Symptomatic aortic stenosis, moderate",
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Transcatheter aortic valve replacement (TAVR) evaluation is a plausible intervention for Symptomatic aortic stenosis, moderate (I35.0).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/28/2026",
    "Date of Service (requested): 03/08/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0124 under Aetna Clinical Policy Bullet",
