# Gumloop verbose pass — case_288_aetna_priorauth
...
```json
{
  ...
  "evidence_quotes": [
    "age=27",
    "gender=M",
    "diagnosis=Symptomatic uterine fibroids (D25.9)",
    "treatment_requested=Myomectomy for fertility preservation"
  ]
}
```
...
```json
{
  "case_id": "case_288_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
