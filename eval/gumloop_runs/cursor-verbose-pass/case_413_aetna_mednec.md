# Gumloop verbose pass — case_413_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** experimental_despite_fda_approval, algo_reviewer_no_credentials  
**Profile:** 49M, Myasthenia gravis, generalized (G70.00), Eculizumab (Soliris)
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/17/2026",
    "Date of Service (requested): 02/25/2026"
  ],
  "improvement": null
}
```
