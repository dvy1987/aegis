# Gumloop verbose pass — case_474_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** circular_medical_necessity, step_therapy_vague_mcg  
**Profile:** 27M, Adrenal insufficiency, primary (E27.1), Hydrocortisone stress-dose education plus ACTH stim retest
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM134 under UnitedHealthcare Coverage D",
    "provided does not satisfy the MCG Care Guidelines (edition not specifi"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_474_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
