# Gumloop verbose pass — case_493_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** experimental_despite_fda_approval, non_specialist_reviewer  
**Profile:** 19F, Deviated nasal septum with obstruction (J34.2), Septoplasty
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Deviated nasal septum with obstruction",
    "Septoplasty",
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/05/2026",
    "Date of Service (requested): 01/16/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0113 under Aetna Clinical Policy Bullet",
...
```json
{
  "case_id": "case_493_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
