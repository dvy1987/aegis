# Gumloop verbose pass — case_262_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** algo_time_delta, wrong_benefit_category  
**Profile:** 42F, Renal cell carcinoma, metastatic clear cell (C64.9), Nivolumab plus cabozantinib
...
```json
{
  "case_id": "case_262_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
