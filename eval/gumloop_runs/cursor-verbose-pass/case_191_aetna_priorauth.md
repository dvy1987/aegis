# Gumloop verbose pass — case_191_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** ignored_physician_letter, wrong_appeals_contact  
**Profile:** 68F, Chronic migraine without aura (G43.709), Erenumab (Aimovig) preventive therapy
...
```json
{
  "case_id": "case_191_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
