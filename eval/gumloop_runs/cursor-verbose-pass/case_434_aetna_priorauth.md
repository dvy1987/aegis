...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 04/07/2026",
    "Date of Service (requested): 03/18/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0134 under Aetna Clinical Policy Bullet",
...
```json
{
  "case_id": "case_434_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
