# Gumloop verbose pass — case_89_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** algo_time_delta, missing_iro_notice  
**Profile:** 34F, Trigeminal neuralgia, classic (G50.0), Microvascular decompression referral
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "34F with Trigeminal neuralgia, classic is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 34, \"gender\": \"F\""
  ],
