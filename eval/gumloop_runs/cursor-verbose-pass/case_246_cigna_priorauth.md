# Gumloop verbose pass — case_246_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** algo_reviewer_no_credentials, missing_erisa_disclosures  
**Profile:** 42M, Adrenal insufficiency, primary (E27.1), Hydrocortisone stress-dose education plus ACTH stim retest
...
```json
{
  "case_id": "case_246_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
