# Gumloop verbose pass — case_429_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** missing_iro_notice, contraindication_to_step_therapy  
**Profile:** 34M, Endometrial cancer, high-grade (C54.1), Adjuvant vaginal brachytherapy
...
```json
{
  ...
  "analysis": "Endometrial cancer, high-grade (C54.1) with Adjuvant vaginal brachytherapy is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
    "Endometrial cancer, high-grade",
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Adjuvant vaginal brachytherapy is a plausible intervention for Endometrial cancer, high-grade (C54.1).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 04/02/2026",
    "Date of Service (requested): 03/13/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "ria. Clinical policy applied: CDG-UM129 under UnitedHealthcare Coverag",
    "ecessary under plan criteria. Clinical policy applied: CDG-UM129 under"
  ],
  "improvement": null
}
```
