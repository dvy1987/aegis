# Gumloop verbose pass — case_446_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** plan_exclusion_overrides_state_mandate, unreasonable_documentation_deadline  
**Profile:** 27M, Symptomatic cholelithiasis (K80.20), Laparoscopic cholecystectomy
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 04/19/2026",
    "Date of Service (requested): 03/30/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical policy applied: Coverage Policy 106 under Cign"
  ],
  "improvement": null
}
```
