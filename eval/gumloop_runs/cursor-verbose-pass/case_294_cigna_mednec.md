# Gumloop verbose pass — case_294_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** missing_cost_liability, algo_boilerplate_fingerprint  
**Profile:** 42F, Normal pressure hydrocephalus, suspected (G91.2), High-volume lumbar puncture trial
...
```json
{
  ...
  "analysis": "Normal pressure hydrocephalus, suspected (G91.2) with High-volume lumbar puncture trial is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=F",
    "diagnosis=Normal pressure hydrocephalus, suspected (G91.2)",
    "treatment_requested=High-volume lumbar puncture trial"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "High-volume lumbar puncture trial is a plausible intervention for Normal pressure hydrocephalus, suspected (G91.2).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Normal pressure hydrocephalus, suspected (G91.2)",
    "High-volume lumbar puncture trial"
