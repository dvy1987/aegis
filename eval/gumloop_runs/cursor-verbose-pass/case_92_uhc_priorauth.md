# Gumloop verbose pass — case_92_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** unreasonable_documentation_deadline, incorrect_demographic_guideline  
**Profile:** 27M, Frozen shoulder (M75.00), Manipulation under anesthesia
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "27M with Frozen shoulder is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 27, \"gender\": \"M\""
  ],
