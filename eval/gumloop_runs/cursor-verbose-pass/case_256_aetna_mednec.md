# Gumloop verbose pass — case_256_aetna_mednec
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=M",
    "diagnosis=Type 1 diabetes mellitus (E10.9)",
    "treatment_requested=Insulin pump upgrade (automated delivery)"
  ]
}
```
