# Gumloop verbose pass — case_207_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** wrong_appeals_contact, contraindication_to_step_therapy  
**Profile:** 49F, Familial hypercholesterolemia (E78.01), PCSK9 inhibitor (evolocumab)
...
```json
{
  "case_id": "case_207_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
