# Gumloop verbose pass — case_439_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** experimental_despite_fda_approval, appeal_closed_as_withdrawn  
**Profile:** 72M, Graves disease with ophthalmopathy (E05.00), Teprotumumab for thyroid eye disease
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 04/12/2026",
    "Date of Service (requested): 03/23/2026"
  ],
  "improvement": null
}
```
