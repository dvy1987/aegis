# Gumloop verbose pass — case_482_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** plan_exclusion_overrides_state_mandate, algo_reviewer_no_credentials  
**Profile:** 42M, Stable angina with positive stress test (I20.9), Coronary CT angiography
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 01/25/2026",
    "Date of Service (requested): 01/05/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0102 under Aetna Clinical Policy Bullet",
