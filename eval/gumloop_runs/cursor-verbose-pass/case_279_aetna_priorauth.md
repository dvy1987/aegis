# Gumloop verbose pass — case_279_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** wrong_benefit_category, superseded_guideline  
**Profile:** 49M, Cushing disease, suspected (E24.0), Pituitary MRI with endocrinology referral
...
```json
{
  ...
  "evidence_quotes": [
    "age=49",
    "gender=M",
    "diagnosis=Cushing disease, suspected (E24.0)",
    "treatment_requested=Pituitary MRI with endocrinology referral"
  ]
}
```
...
```json
{
  "case_id": "case_279_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
