# Gumloop verbose pass — case_400_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** algo_boilerplate_fingerprint, missing_iro_notice  
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/04/2026",
    "Date of Service (requested): 02/12/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "ria. Clinical policy applied: CPB 0100 under Aetna Clinical Policy Bul",
