# Gumloop verbose pass — case_438_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** ignored_physician_letter, missing_erisa_disclosures  
**Profile:** 27M, Menorrhagia due to adenomyosis (N80.0), Endometrial ablation
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 04/11/2026",
    "Date of Service (requested): 03/22/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0138 under Aetna Clinical Policy Bullet",
...
```json
{
  "case_id": "case_438_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
