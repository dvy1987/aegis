# Gumloop verbose pass — case_346_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, appeal_closed_as_withdrawn  
**Profile:** 61F, Wolff-Parkinson-White pattern with SVT (I45.6), Electrophysiology study with ablation
...
```json
{
  ...
  "evidence_quotes": [
    "age=61",
    "gender=F",
    "diagnosis=Wolff-Parkinson-White pattern with SVT (I45.6)",
    "treatment_requested=Electrophysiology study with ablation"
  ]
}
```
...
```json
{
  "case_id": "case_346_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
