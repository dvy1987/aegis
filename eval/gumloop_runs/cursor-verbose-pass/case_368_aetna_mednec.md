# Gumloop verbose pass — case_368_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** wrong_appeals_contact, experimental_despite_fda_approval  
**Profile:** 27M, Pancreatic adenocarcinoma, borderline resectable (C25.9), Neoadjuvant FOLFIRINOX
...
```json
{
  ...
  "analysis": "Pancreatic adenocarcinoma, borderline resectable (C25.9) with Neoadjuvant FOLFIRINOX is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Neoadjuvant FOLFIRINOX is a plausible intervention for Pancreatic adenocarcinoma, borderline resectable (C25.9).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 01/31/2026",
    "Date of Service (requested): 01/11/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0108 under Aetna Clinical Policy Bullet",
