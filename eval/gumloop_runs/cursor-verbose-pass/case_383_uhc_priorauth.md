# Gumloop verbose pass — case_383_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** ignored_physician_letter, appeal_closed_as_withdrawn  
**Profile:** 49M, Morbid obesity with BMI 43 (E66.01), Roux-en-Y gastric bypass
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/15/2026",
    "Date of Service (requested): 01/26/2026"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_383_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
