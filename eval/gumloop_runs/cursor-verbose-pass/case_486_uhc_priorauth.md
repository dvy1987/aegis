# Gumloop verbose pass — case_486_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** unreasonable_documentation_deadline, algo_boilerplate_fingerprint  
**Profile:** 27nonbinary, Long QT syndrome type 2 (I49.5), Genetic cardiology consult and beta-blocker titration
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 01/29/2026",
    "Date of Service (requested): 01/09/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM106 under UnitedHealthcare Coverage D",
    "Clinical policy applied: CDG-UM106 under UnitedHealthca"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_486_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
