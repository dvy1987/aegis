# Gumloop verbose pass — case_69_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** experimental_despite_fda_approval, superseded_guideline  
**Profile:** 49M, Shoulder instability MRI (M25.311), MRI shoulder without contrast
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "49M with Shoulder instability MRI is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 49, \"gender\": \"M\""
  ],
