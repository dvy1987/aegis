# Gumloop verbose pass — case_451_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** superseded_guideline, missing_iro_notice  
**Profile:** 49F, Vulvodynia, generalized (N94.818), Vulvar vestibulitis physical therapy protocol
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 04/24/2026",
    "Date of Service (requested): 04/04/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "erseded guideline reference). CPB 0111 under Aetna Clinical Policy Bul",
...
```json
{
  "case_id": "case_451_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
