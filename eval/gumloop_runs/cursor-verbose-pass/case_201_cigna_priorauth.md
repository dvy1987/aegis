# Gumloop verbose pass — case_201_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** plan_exclusion_overrides_state_mandate, missing_erisa_disclosures  
**Profile:** 72F, Endometrial cancer, high-grade (C54.1), Adjuvant vaginal brachytherapy
...
```json
{
  "case_id": "case_201_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
