# Gumloop verbose pass — case_22_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** incorrect_demographic_guideline, experimental_despite_fda_approval  
**Profile:** 19M, Chronic pelvic pain, suspected endometriosis (R10.2), Diagnostic laparoscopy
...
```json
{
  ...
  "analysis": "Chronic pelvic pain, suspected endometriosis (R10.2) with Diagnostic laparoscopy is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Diagnostic laparoscopy is a plausible intervention for Chronic pelvic pain, suspected endometriosis (R10.2).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Chronic pelvic pain, suspected endometriosis (R10.2)",
    "Diagnostic laparoscopy"
...
```json
{
  ...
  "score": 1,
  "confidence": 0.93,
  "improvement": "MISSING FLAW: Pattern 'experimental_despite_fda_approval' \u2014 add sentence labelling diagnostic laparoscopy as 'experimental/investigational' under plan policy despite standard use for suspected endometriosis."
}
```
...
```json
{
  ...
  "suggested_revisions": [
    "MISSING FLAW: Pattern 'experimental_despite_fda_approval' \u2014 add sentence labelling diagnostic laparoscopy as 'experimental/investigational' under plan policy despite standard use for suspected endometriosis."
  ]
}
```
