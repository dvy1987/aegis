# Gumloop verbose pass — case_470_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** ignored_physician_letter, algo_boilerplate_fingerprint  
**Profile:** 58F, Stable angina with positive stress test (I20.9), Coronary CT angiography
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Stable angina with positive stress test",
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Date of Service (requested): 04/23/2026"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_470_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
