# Gumloop verbose pass — case_432_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** algo_time_delta, plan_exclusion_overrides_state_mandate  
**Profile:** 42F, Lumbar disc herniation, suspected (M51.26), MRI lumbar spine without contrast
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical policy applied: Coverage Policy 132 under Cign"
  ],
  "improvement": null
}
```
...
```json
{
  "case_id": "case_432_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
