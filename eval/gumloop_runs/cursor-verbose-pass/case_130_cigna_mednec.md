# Gumloop verbose pass — case_130_cigna_mednec

**Insurer:** Cigna | **Denial:** Medical Necessity  
**Patterns:** unreasonable_documentation_deadline, superseded_guideline  
**Profile:** 42F, Wolff-Parkinson-White pattern with SVT (I45.6), Electrophysiology study with ablation
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "42F with Wolff-Parkinson-White pattern with SVT is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 42, \"gender\": \"F\""
  ],
