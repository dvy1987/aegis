# Gumloop verbose pass — case_422_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** wrong_benefit_category, algo_boilerplate_fingerprint  
**Profile:** 60M, Idiopathic intracranial hypertension (G93.2), Optic nerve sheath fenestration
...
```json
{
  ...
  "analysis": "Idiopathic intracranial hypertension (G93.2) with Optic nerve sheath fenestration is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Optic nerve sheath fenestration is a plausible intervention for Idiopathic intracranial hypertension (G93.2).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/26/2026",
    "Date of Service (requested): 03/06/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM122 under UnitedHealthcare Coverage D",
    "Clinical policy applied: CDG-UM122 under UnitedHealthca"
  ],
  "improvement": null
}
```
