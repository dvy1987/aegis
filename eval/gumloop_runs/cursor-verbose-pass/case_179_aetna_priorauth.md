# Gumloop verbose pass — case_179_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** non_specialist_reviewer, missing_iro_notice  
**Profile:** 49F, Lumbar radiculopathy with neurogenic claudication (M54.16), L4-L5 microdiscectomy
...
```json
{
  "case_id": "case_179_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
