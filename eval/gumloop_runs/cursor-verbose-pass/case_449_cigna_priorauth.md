# Gumloop verbose pass — case_449_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, algo_time_delta  
**Profile:** 49M, Trigeminal neuralgia, classic (G50.0), Microvascular decompression referral
...
```json
{
  ...
  "analysis": "Trigeminal neuralgia, classic (G50.0) with Microvascular decompression referral is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Microvascular decompression referral is a plausible intervention for Trigeminal neuralgia, classic (G50.0).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  "case_id": "case_449_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
