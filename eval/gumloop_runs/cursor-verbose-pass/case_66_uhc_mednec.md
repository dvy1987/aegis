# Gumloop verbose pass — case_66_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** appeal_closed_as_withdrawn, algo_time_delta  
**Profile:** 42M, Menorrhagia due to adenomyosis (N80.0), Endometrial ablation
...
```json
{
  ...
  "analysis": "Menorrhagia due to adenomyosis (N80.0) with Endometrial ablation is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "42M with Menorrhagia due to adenomyosis is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 42, \"gender\": \"M\""
  ],
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Endometrial ablation is a plausible intervention for Menorrhagia due to adenomyosis (N80.0).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Menorrhagia due to adenomyosis (N80.0)",
    "Endometrial ablation"
