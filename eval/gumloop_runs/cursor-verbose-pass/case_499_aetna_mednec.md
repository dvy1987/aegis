# Gumloop verbose pass — case_499_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** superseded_guideline, algo_reviewer_no_credentials  
**Profile:** 19M, Persistent depressive disorder (F34.1), Spravato (esketamine) nasal therapy
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "erseded guideline reference). CPB 0119 under Aetna Clinical Policy Bul",
