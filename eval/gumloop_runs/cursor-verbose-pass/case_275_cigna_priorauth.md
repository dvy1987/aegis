# Gumloop verbose pass — case_275_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, incorrect_demographic_guideline  
**Profile:** 49F, Morbid obesity with BMI 43 (E66.01), Roux-en-Y gastric bypass
...
```json
{
  ...
  "evidence_quotes": [
    "age=49",
    "gender=F",
    "diagnosis=Morbid obesity with BMI 43 (E66.01)",
    "treatment_requested=Roux-en-Y gastric bypass"
  ]
}
```
...
```json
{
  "case_id": "case_275_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
