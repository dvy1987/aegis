# Gumloop verbose pass — case_149_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** algo_boilerplate_fingerprint, circular_medical_necessity  
**Profile:** 19M, Primary osteoporosis (M81.0), Teriparatide anabolic therapy
...
```json
{
  ...
  "analysis": "Primary osteoporosis (M81.0) with Teriparatide anabolic therapy is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
    "Primary osteoporosis (M81.0)",
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "19M with Primary osteoporosis is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 19, \"gender\": \"M\""
  ],
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Teriparatide anabolic therapy is a plausible intervention for Primary osteoporosis (M81.0).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Primary osteoporosis (M81.0)",
    "Teriparatide anabolic therapy"
