# Gumloop verbose pass — case_172_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** contraindication_to_step_therapy, peer_to_peer_window_verbal_only  
**Profile:** 65F, Symptomatic aortic stenosis, moderate (I35.0), Transcatheter aortic valve replacement (TAVR) evaluation
...
```json
{
  "case_id": "case_172_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
