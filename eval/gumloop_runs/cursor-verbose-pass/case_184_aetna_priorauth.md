# Gumloop verbose pass — case_184_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** plan_exclusion_overrides_state_mandate, appeal_closed_as_withdrawn  
**Profile:** 58M, Symptomatic aortic stenosis, moderate (I35.0), Transcatheter aortic valve replacement (TAVR) evaluation
  ...
  "verification_results": [
    {
      ...
      "status": "PRESENT",
      "evidence": "State mandate override language."
    },
    {
      "pattern_id": "appeal_closed_as_withdrawn",
      "status": "PRESENT",
      "evidence": "Closed-as-withdrawn language."
    }
  ],
  "score": 5,
  "confidence": 0.93,
...
```json
{
  "case_id": "case_184_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
