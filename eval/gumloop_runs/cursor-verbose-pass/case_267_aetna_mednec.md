# Gumloop verbose pass — case_267_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** plan_exclusion_overrides_state_mandate, missing_iro_notice  
**Profile:** 49M, Recurrent bacterial vaginosis (N76.0), Extended suppressive metronidazole course
...
```json
{
  ...
  "evidence_quotes": [
    "age=49",
    "gender=M",
    "diagnosis=Recurrent bacterial vaginosis (N76.0)",
    "treatment_requested=Extended suppressive metronidazole course"
  ]
}
```
