# Gumloop verbose pass — case_353_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** non_specialist_reviewer, appeal_closed_as_withdrawn  
**Profile:** 19F, Myasthenia gravis, generalized (G70.00), Eculizumab (Soliris)
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 05/16/2026",
    "Date of Service (requested): 04/26/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0133 under Aetna Clinical Policy Bullet",
...
```json
{
  "case_id": "case_353_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
