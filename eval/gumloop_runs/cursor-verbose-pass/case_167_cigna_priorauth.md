# Gumloop verbose pass — case_167_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** algo_boilerplate_fingerprint, unreasonable_documentation_deadline  
**Profile:** 69M, Chronic migraine without aura (G43.709), Erenumab (Aimovig) preventive therapy
...
```json
{
  "case_id": "case_167_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
