# Gumloop verbose pass — case_417_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, ignored_physician_letter  
**Profile:** 49F, Ankle instability, chronic lateral (M25.371), Broström ligament repair
...
```json
{
  ...
  "analysis": "Ankle instability, chronic lateral (M25.371) with Broström ligament repair is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
    "Ankle instability, chronic lateral",
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Broström ligament repair is a plausible intervention for Ankle instability, chronic lateral (M25.371).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/21/2026",
    "Date of Service (requested): 03/01/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "ice. Clinical policy applied: CPB 0117 under Aetna Clinical Policy Bul",
...
```json
{
  "case_id": "case_417_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
