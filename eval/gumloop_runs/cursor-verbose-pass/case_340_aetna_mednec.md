# Gumloop verbose pass — case_340_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** ignored_physician_letter, algo_boilerplate_fingerprint  
**Profile:** 58M, Systemic lupus erythematosus, active (M32.10), Belimumab (Benlysta)
...
```json
{
  ...
  "analysis": "Systemic lupus erythematosus, active (M32.10) with Belimumab (Benlysta) is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=58",
    "gender=M",
    "diagnosis=Systemic lupus erythematosus, active (M32.10)",
    "treatment_requested=Belimumab (Benlysta)"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Belimumab (Benlysta) is a plausible intervention for Systemic lupus erythematosus, active (M32.10).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Systemic lupus erythematosus, active (M32.10)",
    "Belimumab (Benlysta)"
