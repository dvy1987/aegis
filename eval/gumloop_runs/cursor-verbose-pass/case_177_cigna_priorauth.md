# Gumloop verbose pass — case_177_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** contraindication_to_step_therapy, missing_iro_notice  
**Profile:** 34F, Post-concussion syndrome (G44.309), Multidisciplinary concussion clinic program
...
```json
{
  "case_id": "case_177_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
