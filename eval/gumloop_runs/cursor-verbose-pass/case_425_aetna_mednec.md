# Gumloop verbose pass — case_425_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** wrong_appeals_contact, non_specialist_reviewer  
**Profile:** 34M, Compression fracture T12, osteoporotic (M80.08XA), Kyphoplasty
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/29/2026",
    "Date of Service (requested): 03/09/2026"
  ],
  "improvement": null
}
```
