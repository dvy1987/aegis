# Gumloop verbose pass — case_147_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** contraindication_to_step_therapy, wrong_benefit_category  
**Profile:** 49F, Parkinson disease, motor fluctuations (G20), Duopa pump evaluation
...
```json
{
  ...
  "analysis": "Parkinson disease, motor fluctuations (G20) with Duopa pump evaluation is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "49F with Parkinson disease, motor fluctuations is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 49, \"gender\": \"F\""
  ],
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Duopa pump evaluation is a plausible intervention for Parkinson disease, motor fluctuations (G20).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Parkinson disease, motor fluctuations (G20)",
    "Duopa pump evaluation"
...
```json
{
  "case_id": "case_147_uhc_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
