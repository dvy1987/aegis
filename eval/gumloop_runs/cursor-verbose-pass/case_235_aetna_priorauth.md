# Gumloop verbose pass — case_235_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, ignored_physician_letter  
**Profile:** 34M, Achilles tendinopathy, chronic (M76.60), Platelet-rich plasma injection
...
```json
{
  "case_id": "case_235_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
