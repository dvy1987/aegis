# Gumloop verbose pass — case_248_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** algo_boilerplate_fingerprint, wrong_appeals_contact  
**Profile:** 42F, Social anxiety disorder, severe (F40.10), Group cognitive behavioral therapy (16 sessions)
...
```json
{
  "case_id": "case_248_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
