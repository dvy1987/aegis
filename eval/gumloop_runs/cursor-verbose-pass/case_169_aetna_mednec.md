# Gumloop verbose pass — case_169_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** appeal_closed_as_withdrawn, ignored_physician_letter  
**Profile:** 34F, Refractory hypertension (I10), Renal denervation referral
...
```json
{
  ...
  "analysis": "Refractory hypertension (I10) with Renal denervation referral is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Renal denervation referral is a plausible intervention for Refractory hypertension (I10).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Refractory hypertension (I10)",
    "Renal denervation referral"
