# Gumloop verbose pass — case_241_aetna_priorauth

**Insurer:** Aetna | **Denial:** Prior Authorization  
**Patterns:** appeal_closed_as_withdrawn, wrong_appeals_contact  
**Profile:** 34M, Severe obsessive-compulsive disorder (F42.2), Transcranial magnetic stimulation (TMS)
...
```json
{
  "case_id": "case_241_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
