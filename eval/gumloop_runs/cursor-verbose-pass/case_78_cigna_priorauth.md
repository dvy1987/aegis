# Gumloop verbose pass — case_78_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** superseded_guideline, missing_iro_notice  
**Profile:** 27F, Menorrhagia due to adenomyosis (N80.0), Endometrial ablation
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "27F with Menorrhagia due to adenomyosis is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 27, \"gender\": \"F\""
  ],
...
```json
{
  "case_id": "case_78_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
