# Gumloop verbose pass — case_281_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** unreasonable_documentation_deadline, algo_boilerplate_fingerprint  
**Profile:** 61nonbinary, Recurrent vasovagal syncope (R55), Implantable loop recorder
...
```json
{
  ...
  "evidence_quotes": [
    "age=61",
    "gender=nonbinary",
    "diagnosis=Recurrent vasovagal syncope (R55)",
    "treatment_requested=Implantable loop recorder"
  ]
}
```
...
```json
{
  "case_id": "case_281_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
