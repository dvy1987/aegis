# Gumloop verbose pass — case_410_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** experimental_despite_fda_approval, algo_time_delta  
**Profile:** 27M, Metastatic castration-sensitive prostate cancer (C61), Apalutamide plus androgen deprivation therapy
...
```json
{
  ...
  "evidence_quotes": [
    ...
    "Clinical policy applied: Coverage Policy 110 under Cign"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "verification_results": [
    ...
    },
    {
      ...
      "status": "PRESENT",
      "evidence": "Timestamps present: sub=2026-03-10T14:00:00Z, den=2026-03-10T14:04:00Z."
    }
  ],
  "score": 5,
  "confidence": 0.93,
...
```json
{
  "case_id": "case_410_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
