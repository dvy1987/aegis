# Gumloop verbose pass — case_277_cigna_priorauth

**Insurer:** Cigna | **Denial:** Prior Authorization  
**Patterns:** peer_to_peer_window_verbal_only, plan_exclusion_overrides_state_mandate  
**Profile:** 34M, Pelvic floor dysfunction postpartum (N81.9), Pelvic floor physical therapy (12 visits)
...
```json
{
  ...
  "analysis": "Pelvic floor dysfunction postpartum (N81.9) with Pelvic floor physical therapy (12 visits) is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "evidence_quotes": [
    "age=34",
    "gender=M",
    "diagnosis=Pelvic floor dysfunction postpartum (N81.9)",
    "treatment_requested=Pelvic floor physical therapy (12 visits)"
  ]
}
```
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Pelvic floor physical therapy (12 visits) is a plausible intervention for Pelvic floor dysfunction postpartum (N81.9).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Pelvic floor dysfunction postpartum (N81.9)",
    "Pelvic floor physical therapy (12 visits)"
...
```json
{
  "case_id": "case_277_cigna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "REVISE",
