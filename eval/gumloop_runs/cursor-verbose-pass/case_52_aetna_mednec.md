# Gumloop verbose pass — case_52_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** ignored_physician_letter, experimental_despite_fda_approval  
**Profile:** 19M, Non-small cell lung cancer, stage IV EGFR+ (C34.90), Osimertinib third-line after T790M-negative progression
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "19M with Non-small cell lung cancer, stage IV EGFR+ is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 19, \"gender\": \"M\""
  ],
