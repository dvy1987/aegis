# Gumloop verbose pass — case_330_aetna_priorauth
...
```json
{
  ...
  "evidence_quotes": [
    "age=42",
    "gender=F",
    "diagnosis=Menorrhagia due to adenomyosis (N80.0)",
    "treatment_requested=Endometrial ablation"
  ]
}
```
...
```json
{
  "case_id": "case_330_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
