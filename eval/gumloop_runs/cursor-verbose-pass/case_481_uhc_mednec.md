# Gumloop verbose pass — case_481_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** missing_iro_notice, algo_boilerplate_fingerprint  
**Profile:** 34F, Severe obsessive-compulsive disorder (F42.2), Transcranial magnetic stimulation (TMS)
...
```json
{
  ...
  "analysis": "Severe obsessive-compulsive disorder (F42.2) with Transcranial magnetic stimulation (TMS) is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Transcranial magnetic stimulation (TMS) is a plausible intervention for Severe obsessive-compulsive disorder (F42.2).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "ria. Clinical policy applied: CDG-UM101 under UnitedHealthcare Coverag",
    "ecessary under plan criteria. Clinical policy applied: CDG-UM101 under"
  ],
  "improvement": null
}
```
