# Gumloop verbose pass — case_65_uhc_priorauth

**Insurer:** UHC | **Denial:** Prior Authorization  
**Patterns:** missing_iro_notice, circular_medical_necessity  
**Profile:** 57F, Myasthenia gravis, generalized (G70.00), Eculizumab (Soliris)
...
```json
{
  ...
  "analysis": "Myasthenia gravis, generalized (G70.00) with Eculizumab (Soliris) is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "57F with Myasthenia gravis, generalized is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 57, \"gender\": \"F\""
  ],
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Eculizumab (Soliris) is a plausible intervention for Myasthenia gravis, generalized (G70.00).",
  "confidence": 0.96,
  "evidence_quotes": [
    "Myasthenia gravis, generalized (G70.00)",
    "Eculizumab (Soliris)"
