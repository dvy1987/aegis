# Gumloop verbose pass — case_420_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** timeline_violation, algo_time_delta  
**Profile:** 42M, Hypothyroidism, inadequately controlled (E03.9), Liothyronine (T3) adjunct therapy
...
```json
{
  ...
  "analysis": "Hypothyroidism, inadequately controlled (E03.9) with Liothyronine (T3) adjunct therapy is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
    "Hypothyroidism, inadequately controlled",
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Liothyronine (T3) adjunct therapy is a plausible intervention for Hypothyroidism, inadequately controlled (E03.9).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM120 under UnitedHealthcare Coverage D",
    "Clinical policy applied: CDG-UM120 under UnitedHealthca"
  ],
  "improvement": null
}
```
  ...
  "verification_results": [
    {
      ...
      "status": "PRESENT",
      "evidence": "Timeline gap timestamps: sub=2026-03-10T14:00:00Z, den=2026-03-10T14:02:00Z."
    },
    {
