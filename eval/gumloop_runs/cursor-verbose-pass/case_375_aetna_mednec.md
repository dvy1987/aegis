# Gumloop verbose pass — case_375_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** wrong_appeals_contact, wrong_benefit_category  
**Profile:** 72F, Incidental adrenal nodule 2.8 cm (E27.8), Adrenal protocol CT
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Incidental adrenal nodule 2.8 cm",
    "Adrenal protocol CT",
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/07/2026",
    "Date of Service (requested): 01/18/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0115 under Aetna Clinical Policy Bullet",
