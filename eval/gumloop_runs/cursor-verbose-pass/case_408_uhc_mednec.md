# Gumloop verbose pass — case_408_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** circular_medical_necessity, unreasonable_documentation_deadline  
**Profile:** 42F, Generalized anxiety disorder (F41.1), Additional psychotherapy visits beyond plan annual limit
...
```json
{
  ...
  "analysis": "Generalized anxiety disorder (F41.1) with Additional psychotherapy visits beyond plan annual limit is a clinically coherent commercial UM scenario; clinical_context aligns with profile.",
  "score": 5,
  "confidence": 0.9,
  "evidence_quotes": [
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "Additional psychotherapy visits beyond plan annual limit is a plausible intervention for Generalized anxiety disorder (F41.1).",
  "confidence": 0.96,
  "evidence_quotes": [
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/12/2026",
    "Date of Service (requested): 02/20/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CDG-UM108 under UnitedHealthcare Coverage D",
    "Clinical policy applied: CDG-UM108 under UnitedHealthca"
  ],
  "improvement": null
}
```
