...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/02/2026",
    "Date of Service (requested): 01/13/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "rrect demographic guideline). CPB 0110 under Aetna Clinical Policy Bul",
...
```json
{
  "case_id": "case_490_aetna_priorauth",
  "evaluator": "Gumloop",
  "verdict": "APPROVE",
