# Gumloop verbose pass — case_83_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** ignored_physician_letter, algo_reviewer_no_credentials  
**Profile:** 34nonbinary, Crohn's disease, moderate to severe (K50.90), Ustekinumab (Stelara) maintenance infusion
...
```json
{
  ...
  "verdict": "PASS",
  "analysis": "34nonbinary with Crohn's disease, moderate to severe is plausible in US commercial populations.",
  "confidence": 0.95,
  "evidence_quotes": [
    "age\": 34, \"gender\": \"nonbinary\""
  ],
  "improvement": null
}
```
