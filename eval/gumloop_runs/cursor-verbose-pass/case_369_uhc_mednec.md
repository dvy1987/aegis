# Gumloop verbose pass — case_369_uhc_mednec

**Insurer:** UHC | **Denial:** Medical Necessity  
**Patterns:** incorrect_demographic_guideline, step_therapy_vague_mcg  
**Profile:** 19F, Gestational diabetes on insulin (O24.414), Continuous glucose monitoring during pregnancy
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "rrect demographic guideline). CDG-UM109 under UnitedHealthcare Coverag",
