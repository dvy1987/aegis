# Gumloop verbose pass — case_378_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** appeal_closed_as_withdrawn, wrong_benefit_category  
**Profile:** 42M, Long QT syndrome type 2 (I49.5), Genetic cardiology consult and beta-blocker titration
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 02/10/2026",
    "Date of Service (requested): 01/21/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0118 under Aetna Clinical Policy Bullet",
