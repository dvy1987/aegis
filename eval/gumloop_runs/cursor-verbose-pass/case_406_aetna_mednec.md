# Gumloop verbose pass — case_406_aetna_mednec

**Insurer:** Aetna | **Denial:** Medical Necessity  
**Patterns:** non_specialist_reviewer, plan_exclusion_overrides_state_mandate  
...
```json
{
  ...
  "confidence": 0.9,
  "evidence_quotes": [
    "Date of Notice: 03/10/2026",
    "Date of Service (requested): 02/18/2026"
  ],
  "improvement": null
}
```
...
```json
{
  ...
  "confidence": 0.85,
  "evidence_quotes": [
    "Clinical policy applied: CPB 0106 under Aetna Clinical Policy Bullet",
