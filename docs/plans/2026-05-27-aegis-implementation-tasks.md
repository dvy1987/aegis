# Aegis — Agent-Pickable Task List (Day 1 – Day 20)

> Flat companion to [`2026-05-27-aegis-implementation-plan.md`](2026-05-27-aegis-implementation-plan.md). Each task is pickable by a single coding-agent session: clear DoD, traces to a PRD ID, no hidden dependencies.
>
