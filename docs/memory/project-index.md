...
| 2026-06-03 | Handoff (🔴 **CRITICAL: library → judges → Phoenix** — PM building library first; no simulator-score shortcut; wire Vertex env so `citations_used>0`; then librarian-when-thin, judge panel, live `/showcase`, Phoenix MCP reads) | [agent-handoffs.md](agent-handoffs.md#2026-06-03--handoff-cursor--critical-library--judges--phoenix-improvement-path) |
